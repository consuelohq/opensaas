---
title: 准备您的 CSV 文件
description: 完整的分步指南，指导您将数据格式化以导入 Consuelo。
---
...
**这是最重要的一步。** 示例文件展示了 Consuelo 期望的准确列名和格式。
...
Consuelo 会对某些字段强制唯一性。 重复项会导致导入错误。
