---
title: 开始使用
description: 欢迎来到 Consuelo 开发者文档，这是您用于扩展、自托管以及为 Consuelo 做出贡献的资源。
---
...
<CardGroup cols={3}>
  ...
  <Card href="/l/zh/developers/self-host/self-host" img="/images/user-guide/what-is-consuelo/20.png">
    <CardTitle>自托管</CardTitle>
    在您自己的基础设施上部署并管理 Consuelo。
  </Card>

  <Card href="/l/zh/developers/contribute/contribute" img="/images/user-guide/github/github-header.png">
    <CardTitle>贡献</CardTitle>
    加入我们的开源社区并为 Consuelo 做出贡献。
  </Card>
</CardGroup>
