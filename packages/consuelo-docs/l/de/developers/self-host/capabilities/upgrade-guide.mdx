...
1. Schalten Sie Consuelo in einem Terminal auf dem Host, auf dem Consuelo läuft, mit `docker compose down` aus.
...
3. Schalten Sie Consuelo mit `docker compose up -d` wieder ein.
...
Bitte aktualisieren Sie Ihre lokale `docker-compose.yml` mit der [docker-compose.yml v0.50.0](https://github.com/consuelohq/opensaas/blob/v0.50.0/packages/twenty-docker/docker-compose.yml)
...
2. Aktualisieren Sie Ihre docker-compose.yml, um das postgres:16-Image gemäß der [docker-compose.yml](https://raw.githubusercontent.com/consuelohq/opensaas/main/packages/twenty-docker/docker-compose.yml) zu verwenden.
...
**Wichtige Änderung**:
Um die Leistung zu verbessern, erfordert Consuelo jetzt, dass der Redis-Cache konfiguriert wird. Wir haben unser [docker-compose.yml](https://raw.githubusercontent.com/consuelohq/opensaas/main/packages/twenty-docker/docker-compose.yml) aktualisiert, um dies zu reflektieren.
