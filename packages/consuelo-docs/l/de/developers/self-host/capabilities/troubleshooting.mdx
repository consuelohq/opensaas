...
Bei der ersten Installation von Consuelo möchten Sie möglicherweise das Standard-Datenbankpasswort ändern.
...
**Wenn es nicht funktioniert:**
Untersuchen Sie, welche Prozesse den größten Teil Ihres RAMs beanspruchen. Bei Consuelo haben wir festgestellt, dass einige vscode-Erweiterungen viel RAM verwenden, daher deaktivieren wir sie vorübergehend.
...
* Fügen Sie **Ihre einzigartige Webhook-URL** in das Feld **Endpoint-Url** in Consuelo ein. Stellen Sie die **Filter** auf `Companies` und `Created` ein.
...
Wenn Sie Consuelo hinter einem Reverse-Proxy ausführen und Verbindungsprobleme haben:
...
* Unterstützung aus der Community:
  ...
  Wenden Sie sich an die [Consuelo Community](https://github.com/consuelohq/opensaas/issues) oder [Support-Kanäle](https://discord.gg/cx5n4Jzs57) für Unterstützung.
