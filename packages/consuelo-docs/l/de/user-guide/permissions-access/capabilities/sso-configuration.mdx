...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Consuelo anzumelden. Dies bietet:
...
<Note>
  **Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@consuelo.com
</Note>
...
* **Offboarding-Prozess**: Beziehen Sie Consuelo in Ihren Deprovisioning-Workflow ein
