...
<AccordionGroup>
  <Accordion title="Welche Rollen sind in Consuelo standardmäßig enthalten?">
    Consuelo enthält standardmäßig die Rollen **Admin** und **Member**. Sie können je nach Bedarf Ihres Teams zusätzliche benutzerdefinierte Rollen erstellen (z. B. Vertriebsmitarbeiter, Manager, Nur-Lese-Benutzer).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Welche Berechtigungen für Aktionen sind verfügbar?">
    ...
    * **E-Mail senden**: Möglichkeit, E-Mails aus Consuelo zu senden
...
<AccordionGroup>
  ...
  <Accordion title="Was ist Just-in-Time-(JIT)-Bereitstellung?">
    Mit JIT-Bereitstellung werden Benutzerkonten in Consuelo automatisch erstellt, wenn sich jemand zum ersten Mal über SSO anmeldet. Ihnen wird automatisch die Standardrolle zugewiesen.
  </Accordion>
