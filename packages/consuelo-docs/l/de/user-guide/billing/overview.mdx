---
title: Abrechnung
description: Verstehen Sie die Preisgestaltung von Consuelo und verwalten Sie Ihr Abonnement.
...
Consuelo bietet flexible Preispläne, die den Bedürfnissen Ihres Teams entsprechen. Verwalten Sie Ihr Abonnement, verfolgen Sie Workflow-Guthaben und greifen Sie auf Rechnungen zu – alles über **Einstellungen → Abrechnung**.

## Was enthält dieser Abschnitt

<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/l/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von Consuelo und was enthalten ist.
  </Card>
...
**Kann ich Consuelo kostenlos nutzen?**
Ja! Hosten Sie Consuelo selbst und erhalten Sie alle Pro-Funktionen kostenlos.
