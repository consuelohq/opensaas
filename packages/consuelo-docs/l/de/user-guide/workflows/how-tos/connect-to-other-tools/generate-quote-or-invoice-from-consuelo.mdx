---
title: Ein Angebot oder eine Rechnung aus Consuelo erstellen.
...
* [Ein PDF aus Consuelo generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — generierte PDFs an Datensätze anhängen
