---
title: Workflows
description: Erfahren Sie, wie Sie Automatisierungen in Consuelo erstellen.
...
2. **Daten in und aus Consuelo bringen**: Verbinden Sie Consuelo über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
