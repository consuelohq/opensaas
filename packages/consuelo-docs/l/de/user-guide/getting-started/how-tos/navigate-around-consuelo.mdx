...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in Consuelo. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (Consuelo unterstützt weiches und hartes Löschen)
