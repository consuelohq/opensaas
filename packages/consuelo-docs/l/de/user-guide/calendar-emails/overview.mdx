...
description: Verbinden Sie Ihre E-Mail- und Kalenderkonten mit Consuelo.
...
4. Autorisieren Sie Consuelo, auf Ihr Gmail-Konto und Ihren Google-Kalender zuzugreifen
...
4. Autorisieren Sie Consuelo, auf Ihr Outlook-Konto und Ihren Microsoft-Kalender zuzugreifen
5. Konfigurieren Sie die E-Mail-Synchronisierungseinstellungen (Sichtbarkeit, automatische Erstellung) → Klicken Sie auf **Weiter**
6. Konfigurieren Sie die Kalendersynchronisierungseinstellungen (Sichtbarkeit, automatische Erstellung) → Klicken Sie auf **Konto hinzufügen**
7. Ihre E-Mails und Kalendereinträge werden automatisch synchronisiert
...
<Warning>
  Es können nur echte Postfächer verbunden werden (z.B. support@domain.com mit eigenem Posteingang). E-Mail-Aliase, die zu einem anderen Postfach weiterleiten, können nicht mit Consuelo verbunden werden.
</Warning>
...
<Note>Wenn aktiviert, werden Kontakte basierend auf ihrer E-Mail-Domain automatisch mit ihren Unternehmensdatensätzen verknüpft. Falls das Unternehmen noch nicht existiert, erstellt Consuelo es für Sie.</Note>

### Steuern Sie mit der Ordnerauswahl, welche E-Mails synchronisiert werden.

Bestimmen Sie, welche E-Mail-Ordner mit Consuelo synchronisiert werden:
...
**Hinweis**: Wir bieten keine CC-E-Mail-Adresse für selektives Synchronisieren an. Verwenden Sie stattdessen die oben genannte Nachrichtenordner-Funktion, um dieselbe Kontrolle darüber zu erhalten, welche E-Mails mit Consuelo synchronisiert werden.
...
<Note>
  **Dauer der Erstsynchronisierung**: Die Kalendersynchronisierung wird schnell abgeschlossen (in der Regel innerhalb von Minuten), während die E-Mail-Synchronisierung bei großen Postfächern länger dauert. Consuelo importiert E-Mails mit etwa **400 Nachrichten pro Minute** (begrenzt durch die Ratenbegrenzung der Gmail API), daher dauert es bei einem Postfach mit 10.000 E-Mails etwa 25 Minuten. Keine Sorge, wenn Kontakte aus Kalenderereignissen vor Ihren E-Mail-Kontakten erscheinen; das ist normales Verhalten.
</Note>
