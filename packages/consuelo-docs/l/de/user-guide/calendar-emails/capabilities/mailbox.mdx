---
title: Postfach
description: E-Mail-Integrationsfunktionen in Consuelo verstehen.
---
...
Consuelo verknüpft E-Mails automatisch aus Ihren verknüpften Postfächern mit den relevanten CRM-Datensätzen, um den gesamten Kommunikationsverlauf an einem Ort zu halten.
...
Consuelo importiert E-Mails mit ungefähr **400 Nachrichten pro Minute**. Diese Rate ist derzeit durch das Ratenlimit der Gmail-API begrenzt (und gilt ähnlich für andere Anbieter).
