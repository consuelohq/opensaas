...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten Twenty-Instanz zu Consuelo Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten Twenty-Instanz zu Consuelo Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.consuelo.com](https://app.consuelo.com) und erstellen Sie einen neuen Arbeitsbereich
...
Bei komplexen Migrationen oder großen Datenmengen kontaktieren Sie uns unter [contact@consuelo.com](mailto:contact@consuelo.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
