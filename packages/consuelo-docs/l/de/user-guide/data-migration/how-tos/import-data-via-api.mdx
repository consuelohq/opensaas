...
description: Wann und wie Sie die APIs von Consuelo für groß angelegte Datenimporte verwenden.
---

## Übersicht

Consuelo stellt sowohl **GraphQL**- als auch **REST-APIs** für den programmatischen Datenimport bereit. Verwenden Sie die API, wenn der CSV-Import für Ihr Datenvolumen nicht praktikabel ist oder wenn Sie automatisierte, wiederkehrende Importe benötigen.
...
Consuelo setzt Rate-Limits durch, um die Systemstabilität zu gewährleisten:
...
Consuelo unterstützt zwei API-Typen:
...
* Überprüfen Sie, ob die Formate den Anforderungen von Consuelo entsprechen (siehe [Feldzuordnung](/l/de/user-guide/data-migration/capabilities/field-mapping))
...
* Überprüfen Sie, ob die Daten in Consuelo korrekt angezeigt werden
...
Kontaktieren Sie uns unter [contact@consuelo.com](mailto:contact@consuelo.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
