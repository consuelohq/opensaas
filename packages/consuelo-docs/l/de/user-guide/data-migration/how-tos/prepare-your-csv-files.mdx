...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in Consuelo.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das Consuelo erwartet.
...
Consuelo erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in Consuelo bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in Consuelo)
...
* Muss innerhalb deiner Datei und in Consuelo eindeutig sein
...
* **Links / Link-URL**: `https://consuelo.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://consuelo.com","label":"Twenty"}]
```
...
* **Optional**: Consuelo erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in Consuelo vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in Consuelo vorhanden sind
