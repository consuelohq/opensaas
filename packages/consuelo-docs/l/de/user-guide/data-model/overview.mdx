...
Consuelo enthält Standardobjekte:
...
Jedes Unternehmen arbeitet anders. Die Anpassung Ihres Datenmodells bedeutet, dass Sie Consuelo um **Ihre** Prozesse herum gestalten können, anstatt Ihre in ein starres System zu zwängen.

Consuelo bietet volle Flexibilität:
...
Identifizieren Sie die wichtigsten Konzepte, mit denen Sie arbeiten. Consuelo bietet bereits:
