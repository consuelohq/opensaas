---
title: Consuelo'den Teklif veya Fatura Oluşturun
...
* [Consuelo'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — oluşturulan PDF'leri kayıtlara ekleyin
