...
description: Consuelo'ye kaydolma, bir abonelik planı seçme ve hesabınızı kurma konusunda adım adım kılavuzu takip edin.
---
...
1. [Consuelo Kayıt](https://app.twenty.com) sayfasına gidin.
