...
description: Hangi e-postaların Consuelo'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, Consuelo bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
