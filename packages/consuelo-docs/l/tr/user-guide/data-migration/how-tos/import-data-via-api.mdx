...
description: Büyük ölçekli veri içe aktarmaları için Consuelo'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

Consuelo, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
Consuelo, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
Consuelo iki API türünü destekler:
...
* Biçimlerin Consuelo'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin Consuelo'de doğru göründüğünü doğrulayın
