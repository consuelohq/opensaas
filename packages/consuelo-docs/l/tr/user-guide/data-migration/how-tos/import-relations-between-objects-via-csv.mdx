...
Ana ("bir" taraf) kaydı, ona referans verebilmeden önce Consuelo'de mevcut olmalıdır.
...
1. Ana kayıtları Consuelo'den dışa aktarın
...
<Warning>
  **Alan adı biçimi önemlidir!**
  ...
  `https://domain.com` kullanın (yalnızca `domain.com` değil). Bu, Consuelo'nin Şirket alan adlarını saklama biçimiyle eşleşir ve eşleştirme hatalarını önler.
</Warning>
...
Consuelo, her alt kaydı otomatik olarak eşleşen ana kayda bağlar.
...
| **Mevcut olmayan kayıtlar**      | Ana kayıt Consuelo'de mevcut değil               | Önce ana kayıtları içe aktarın veya yazım hatalarını kontrol edin |
| **Büyük/küçük harf uyumsuzluğu** | Dosyada `Acme.com`, Consuelo'de ise `acme.com`   | Bire bir büyük/küçük harf eşleşmesini sağlayın                    |
...
<AccordionGroup>
  <Accordion title="Ana kaydımın alan adı veya e-postası yoksa ne olur?">
    ...
    1. Consuelo `id` değerini kullanın (kimlikleri almak için ana kayıtları dışa aktarın)
