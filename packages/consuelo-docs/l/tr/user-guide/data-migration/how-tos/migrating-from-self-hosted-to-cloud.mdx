...
description: Consuelo kendi barındırmalı örneğinizi Consuelo Cloud’a taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi Consuelo kendi barındırmalı örneğinizden Consuelo Cloud’a taşıma sürecinde size adım adım yol gösterir. Süreç; bulut çalışma alanınızı kurmayı, verilerinizi dışa aktarmayı ve yeniden içe aktarmayı içerir.
...
1. [app.consuelo.com](https://app.twenty.com) adresine gidin ve yeni bir çalışma alanı oluşturun
