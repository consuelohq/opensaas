...
Dosyanızı yükledikten ve sütunları eşledikten sonra, Consuelo verilerinizi doğrular:

1. **Doğrulama çalışır** — Consuelo her satırı hatalar için kontrol eder
...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Yinelenen değerler sarı renkle vurgulanır                                      | Değer Consuelo'de zaten mevcut veya dosyanızda iki kez görünüyor |
...
**Seçenek 3: Mevcut kaydı Consuelo'nin güncellemesine izin verin**
...
3. Consuelo, yinelenen bir kayıt oluşturmak yerine mevcut kaydı güncelleyecektir
...
<Note>
  ...
  * `email`'i korur ancak `id`'yi değiştirirseniz → id güncellenir
  ...
  Benzersiz tanımlayıcılardan biri eşleştiği sürece Consuelo kaydı günceller.
</Note>
...
3. Kayıtların Consuelo'de zaten mevcut olup olmadığını kontrol edin
...
Bu, Consuelo'de o özel tanımlayıcıya sahip bir Şirket olmadığı anlamına gelir.
...
Consuelo'de mevcut olmayan bir kayda bağlanmaya çalışıyorsunuz.
...
Dosyanızdaki bir sütun eşlenemiyor çünkü alan Consuelo'de mevcut değil.
...
1. **Kullanıcı davetini kabul etmedi** — kullanıcı henüz Consuelo'de mevcut değil
2. **Eski sistemdeki kullanıcı kimliğini kullanma** — Consuelo başka bir sistemin kimliklerini eşleştiremez
3. **Yanlış e-posta biçimi** — e-posta, kullanıcının Consuelo hesabıyla eşleşmiyor

### Nasıl Düzeltilir

1. Tüm kullanıcıların Consuelo çalışma alanınıza **davetlerini kabul ettiğinden** emin olun
2. Kullanıcının **e-posta adresini** kullanın (adlarını veya eski sistem kimliğini değil)
3. Consuelo'ye katılmak için kullandıkları aynı e-postayı kullanın
...
<Check>Alan adı biçimi, Consuelo'nin biçimiyle birebir eşleşir</Check>
...
1. **Örnek dosyayı indirin** — Consuelo'nin beklediği tam biçimi görün
