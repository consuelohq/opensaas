...
description: Consuelo'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
Consuelo açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız Consuelo'yi herkes için daha iyi hâle getirmeye yardımcı olur.
