...
1. Yirmi'nin çalıştığı sunucuda bir terminalde, Consuelo'yi kapatın: `docker compose down`

2. Sürümü yükseltmek için .env dosyanızdaki `TAG` değerini değiştirin. ( `v0.53` gibi `major.minor` sürümler tüketmenizi öneririz )

3. Consuelo'yi `docker compose up -d` ile tekrar çevrimiçi hale getirin.
...
Consuelo örneğinizi v0.55 görüntüsünü kullanacak şekilde yükseltin
...
Bu sorun, bu Consuelo sürümüne özgüdür ve gelecekteki yükseltmeler için gerekli olmamalıdır.
...
Her zaman, mevcut Consuelo örneğinizin `major.minor` sürüm aralığında olması gerekir, örnek sürümünüzü yönetici panelinde (veritabanında `canAccessFullAdminPanel` özelliği true olarak ayarlandığında `settings/admin-panel` altında bulunabilir) veya `twenty-server` konteynerinizde `echo $APP_VERSION` çalıştırarak görüntüleyebilirsiniz.
...
Consuelo sürümünüzü v0.52 görüntüsünü kullanacak şekilde yükseltin
...
Veritabanında çalışma alanı sürümünüzü manuel olarak `0.51.0` olarak güncelleyip, yukarıdaki yükseltme kılavuzunu takip ederek Consuelo sürümü `0.52.11` ile yükseltmeniz gerekecek.

### v0.50'den v0.51'e

Consuelo sürümünüzü v0.51 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.50.0 görüntüsünü kullanacak şekilde yükseltin
...
Yerel `docker-compose.yml` dosyanızı [v0.50.0 docker-compose.yml](https://github.com/twentyhq/consuelo/blob/v0.50.0/packages/twenty-docker/docker-compose.yml) ile güncelleyin

### v0.43.0'dan v0.44.0'a

Consuelo sürümünüzü v0.44.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.43.0 görüntüsünü kullanacak şekilde yükseltin
...
2. docker-compose.yml dosyanızı postgres:16 görüntüsü ile kullanacak şekilde yükseltin [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml) dosyasında belirtildiği gibi güncelleyin.
...
Consuelo sürümünüzü v0.42.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.41.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.40.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.35.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo örneğinizi v0.34.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo örneğinizi v0.33.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo-postgres görüntüsünü kullanmaya devam etmek istiyorsanız, docker-compose.yml dosyasında `Consuelo/twenty-postgres:${TAG}`i `Consuelo/twenty-postgres` ile değiştirin.

### v0.31.0'dan v0.32.0'ya

Consuelo örneğinizi v0.32.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo örneğinizi v0.31.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.30.0 görüntüsünü kullanacak şekilde yükseltin

**Yıkıcı değişiklik**:
Performansı artırmak için Consuelo artık redis önbelleğinin yapılandırılmasını gerektirir. [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml) dosyamızı bu durumu yansıtacak şekilde güncelledik.
...
Consuelo sürümünüzü v0.24.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.23.0 görüntüsünü kullanacak şekilde yükseltin
...
Consuelo sürümünüzü v0.22.0 görüntüsünü kullanacak şekilde yükseltin
