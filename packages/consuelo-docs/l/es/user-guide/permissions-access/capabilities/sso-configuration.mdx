...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en Consuelo utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de Consuelo

<Note>
  **Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@consuelo.com
</Note>
...
* **Entity ID**: Proporcionado por Consuelo
* **ACS URL**: La URL de retorno para la autenticación
* **Certificado**: Para comunicación segura

#### 4. Introduzca los detalles del proveedor en Consuelo
...
* Elimínelos del espacio de trabajo de Consuelo
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de Consuelo (si está disponible)
* **Proceso de desvinculación**: Incluya Consuelo en su flujo de trabajo de desaprovisionamiento
