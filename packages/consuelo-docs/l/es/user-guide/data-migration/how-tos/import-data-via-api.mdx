...
description: Cuándo y cómo usar las API de Consuelo para importaciones de datos a gran escala.
---

## Resumen

Consuelo ofrece tanto **GraphQL** como **API REST** para la importación programática de datos. Utiliza la API cuando la importación mediante CSV no sea práctica para tu volumen de datos o cuando necesites importaciones automatizadas y recurrentes.
...
Consuelo aplica límites de tasa para garantizar la estabilidad del sistema:
...
Consuelo admite dos tipos de API:
...
* Verifica que los formatos cumplan los requisitos de Consuelo (consulta [Asignación de campos](/l/es/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica que los datos aparezcan correctamente en Consuelo
...
Contáctanos en [contact@consuelo.com](mailto:contact@consuelo.com) o explora nuestros [Servicios de implementación](/l/es/user-guide/getting-started/capabilities/implementation-services).
