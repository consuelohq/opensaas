...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Consuelo.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Consuelo espera.
...
Consuelo exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Consuelo
...
* Debe ser único (sin duplicados en el archivo ni en Consuelo)
...
* Debe ser único dentro de tu archivo y en Consuelo
...
* **Enlaces / URL del enlace**: `https://consuelo.com`
...
* **Opcional**: Consuelo genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Consuelo
...
## Paso 6: Asegúrate de que los campos existan en Consuelo
