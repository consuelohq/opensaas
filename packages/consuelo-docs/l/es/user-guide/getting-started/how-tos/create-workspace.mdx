...
description: Siga una guía paso a paso sobre cómo registrarse en Consuelo, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Consuelo Sign Up](https://app.consuelo.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@consuelo.com](mailto:contact@consuelo.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
