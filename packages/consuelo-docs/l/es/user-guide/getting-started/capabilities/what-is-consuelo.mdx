---
title: ¿Qué es Consuelo
description: Consuelo es un CRM de código abierto que te brinda los componentes básicos para crear exactamente lo que tu empresa necesita.
---
...
Al principio, Consuelo parece como la mayoría de los CRMs que ya conoces: puedes rastrear ofertas, organizar contactos, gestionar tareas y notas.
...
El código abierto es la base de nuestro enfoque, asegurando que Consuelo evoluciona con su comunidad, para su comunidad.
...
[Regístrate aquí](https://app.consuelo.com) o [conviértete en un colaborador en GitHub](https://github.com/consuelohq/opensaas).
