...
description: Obtén información sobre los planes de precios de Consuelo y cómo cambiar entre ellos.
---

## Resumen

Consuelo ofrece precios flexibles para adaptarse a equipos de todos los tamaños, tanto si prefieres alojamiento en la nube como autoalojamiento.
...
Aloja Consuelo en tu propia infraestructura sin costo:
...
* **Funciones premium**: integración de SSO y permisos a nivel de fila
* Soporte del equipo de Consuelo
