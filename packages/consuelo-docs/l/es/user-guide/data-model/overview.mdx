...
Consuelo incluye objetos estándar:
...
Cada empresa funciona de manera diferente. Personalizar tu modelo de datos significa que puedes adaptar Consuelo a **tus** procesos en lugar de forzar los tuyos en un sistema rígido.

Consuelo ofrece total flexibilidad:
...
Identifica los conceptos principales con los que trabajas. Consuelo ya ofrece:
