...
description: Segui una guida passo passo su come registrarti su Consuelo, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su Consuelo](https://app.consuelo.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@consuelo.com](mailto:contact@consuelo.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
