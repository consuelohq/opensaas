...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a Consuelo utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Consuelo

<Note>
  **Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@consuelo.com
</Note>
...
* Rimuovili dallo spazio di lavoro Consuelo
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Consuelo (se disponibile)
* **Processo di offboarding**: Includi Consuelo nel tuo flusso di lavoro di deprovisioning
