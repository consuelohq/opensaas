...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in Consuelo.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che Consuelo si aspetta.
...
Consuelo impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in Consuelo
...
* Deve essere univoco (nessun duplicato nel file o in Consuelo)
...
* Deve essere univoco all'interno del tuo file e in Consuelo
...
* **Link / URL del link**: `https://consuelo.com`
...
* **Opzionale**: Consuelo genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in Consuelo
...
## Passaggio 6: Verifica che i campi esistano in Consuelo
