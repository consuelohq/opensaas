...
description: Guida passo-passo per migrare la tua istanza Consuelo self-hosted verso Consuelo Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza Consuelo self-hosted a Consuelo Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.consuelo.com](https://app.consuelo.com) e crea un nuovo spazio di lavoro
...
Per migrazioni complesse o set di dati di grandi dimensioni, contattaci all'indirizzo [contact@consuelo.com](mailto:contact@consuelo.com) oppure scopri i nostri [Servizi di Implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
