...
description: Domande frequenti sulle impostazioni di Consuelo.
...
<AccordionGroup>
  ...
  <Accordion title="Posso cambiare il mio indirizzo email?">
    Per modificare il tuo indirizzo email, contatta [contact@consuelo.com](mailto:contact@consuelo.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Posso personalizzare il dominio del mio workspace?">
    ...
    * **Sottodominio**: usa un sottodominio di Consuelo come `yourcompany.consuelo.com`
