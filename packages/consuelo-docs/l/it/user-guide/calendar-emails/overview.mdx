...
description: Collega i tuoi account email e calendario a Consuelo.
...
4. Autorizza Consuelo ad accedere al tuo Gmail e Google Calendar
...
4. Autorizza Consuelo ad accedere al tuo Outlook e Microsoft Calendar
5. Configura le impostazioni di sincronizzazione delle email (visibilità, creazione automatica) → fai clic su **Avanti**
6. Configura le impostazioni di sincronizzazione del calendario (visibilità, creazione automatica) → fai clic su **Aggiungi account**
7. Le tue email e gli eventi del calendario inizieranno a sincronizzarsi automaticamente
...
<Warning>
  Solo vere caselle di posta possono essere collegate (es. supporto@dominio.com con la propria inbox). Alias email che inoltrano ad un'altra casella non possono essere collegati a Consuelo.
</Warning>
...
<Note>Quando è attivata, i contatti vengono collegati automaticamente ai relativi record di Azienda in base al loro dominio email. Se l'Azienda non esiste ancora, Consuelo la crea per te.</Note>

### Controlla quali email vengono sincronizzate con la Selezione Cartelle Messaggi

Controlla quali cartelle email sincronizzano con Consuelo:
...
**Nota**: Non forniamo un indirizzo email CC per la sincronizzazione selettiva. Invece, usa la funzionalità Cartella Messaggi sopra per ottenere lo stesso livello di controllo su quali email sincronizzano con Consuelo.
