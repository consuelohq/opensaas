...
description: Scopri i piani tariffari di Consuelo e come passare da uno all'altro.
---

## Panoramica

Consuelo offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Consuelo sulla tua infrastruttura senza costi:
