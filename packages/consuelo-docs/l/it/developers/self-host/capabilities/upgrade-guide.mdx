...
1. In un terminale, sull'host dove Consuelo è in esecuzione, spegni Consuelo: `docker compose down`
...
3. Riporta Consuelo online con `docker compose up -d`
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.55
...
Questo problema è specifico per questa versione di Consuelo e non dovrebbe essere richiesto per i futuri aggiornamenti.
...
Dovrebbe sempre essere nell'ambito della versione `major.minor` corrente della tua istanza di Consuelo, puoi visualizzare la tua versione nell'admin panel (su `/settings/admin-panel`, accessibile se il tuo utente ha impostata a vero la proprietà `canAccessFullAdminPanel` nel database) o eseguendo `echo $APP_VERSION` all'interno del tuo contenitore `twenty-server`.

Per correggere una versione di spazio di lavoro desincronizzata, dovrai aggiornare dalla versione corrispondente di Consuelo seguendo la guida all'aggiornamento relativa in modo sequenziale fino a raggiungere la versione desiderata.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.52.
...
Dovrai aggiornare manualmente nel database la versione del workspace a `0.51.0` ed effettuare l'aggiornamento utilizzando la versione `0.52.11` di Consuelo seguendo la guida di aggiornamento appena sopra.

### v0.50 a v0.51

Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.51.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.50.0.
...
Aggiorna il tuo `docker-compose.yml` locale con [v0.50.0 docker-compose.yml](https://github.com/consuelohq/opensaas/blob/v0.50.0/packages/twenty-docker/docker-compose.yml)

### v0.43.0 a v0.44.0

Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.44.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.43.0.
...
2. Aggiorna il tuo docker-compose.yml per utilizzare l'immagine postgres:16 come nel file [docker-compose.yml](https://raw.githubusercontent.com/consuelohq/opensaas/main/packages/twenty-docker/docker-compose.yml)
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.42.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.41.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.40.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.35.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.34.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.33.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.32.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.31.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.30.0.

**Modifica importante**:
Per migliorare le prestazioni, Consuelo ora richiede che la cache Redis sia configurata. Abbiamo aggiornato il nostro [docker-compose.yml](https://raw.githubusercontent.com/consuelohq/opensaas/main/packages/twenty-docker/docker-compose.yml) per riflettere questa modifica.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.24.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.23.0.
...
Aggiorna la tua istanza di Consuelo per utilizzare l'immagine v0.22.0.
