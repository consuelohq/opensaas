...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Consuelo.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Consuelo očekává.
...
Consuelo vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Consuelo existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Consuelo)
...
* Musí být jedinečné v rámci vašeho souboru i v Consuelo
...
* **Odkazy / URL odkazu**: `https://consuelo.com`
...
* **Volitelné**: Consuelo automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Consuelo již existovat
...
## Krok 6: Ujistěte se, že pole v Consuelo existují
