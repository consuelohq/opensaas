...
description: Podrobný průvodce krok za krokem pro migraci vaší instance Consuelo hostované na vlastním serveru do Consuelo Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance Consuelo hostované na vlastním serveru do Consuelo Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.consuelo.com](https://app.consuelo.com) a vytvořte nový pracovní prostor
...
U složitých migrací nebo velkých datových sad nás kontaktujte na [contact@consuelo.com](mailto:contact@consuelo.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
