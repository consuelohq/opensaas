...
Nadřazený („jedna“ strana) musí v Consuelo existovat, než na něj budete moci odkazovat.
...
1. Exportujte nadřazené záznamy z Consuelo
...
<Warning>
  **Na formátu domény záleží!**
  ...
  Použijte `https://domain.com` (ne pouze `domain.com`). To odpovídá způsobu, jak Consuelo ukládá domény společností, a předchází chybám při párování.
</Warning>
...
Consuelo automaticky propojí každý podřízený záznam s odpovídajícím nadřazeným.
...
| **Neexistující záznamy**     | Nadřazený záznam v Consuelo neexistuje            | Nejprve importujte nadřazené záznamy nebo zkontrolujte překlepy |
| **Rozdílná velikost písmen** | `Acme.com` v souboru, ale v Consuelo `acme.com`   | Zajistěte přesnou shodu velikosti písmen                        |
...
<AccordionGroup>
  <Accordion title="Co když můj nadřazený záznam nemá doménu ani e-mail?">
    ...
    1. Použijte Consuelo `id` (exportujte nadřazené záznamy, abyste získali jejich ID)
