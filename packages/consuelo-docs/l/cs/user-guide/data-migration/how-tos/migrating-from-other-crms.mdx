...
description: Podrobný průvodce krok za krokem pro migraci vašich dat z libovolného CRM do Consuelo.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z libovolného CRM do Consuelo. Proces zahrnuje audit vašich dat, přípravu vašeho pracovního prostoru Consuelo, export z vašeho současného systému a import do Consuelo.
...
Vytvořte mapovací dokument mezi vaším současným CRM a Consuelo:
...
## Krok 3: Nastavte svůj pracovní prostor Consuelo

Před importem dat připravte svůj pracovní prostor Consuelo:
...
<Warning>
  **Pozvěte uživatele PŘED importem dat.**
  ...
  Pokud vaše data obsahují odkazy na uživatele (vlastník účtu, přiřazený uživatel apod.), tito uživatelé musí v Consuelo existovat před importem. Jinak tyto relace nelze namapovat.
</Warning>
...
Otevřete každý exportovaný soubor CSV v tabulkovém editoru a připravte jej pro Consuelo.

### Odstraňte duplicity

1. Seřaďte podle jedinečného pole (e-mail u lidí, doména u společností)
2. Odstraňte nebo sloučte duplicitní řádky
3. Ověřte, že v Consuelo již neexistují žádné duplicity
...
<Warning>
  **Formát domény je zásadní.**
  ...
  Použijte `https://domain.com` (ne `domain.com` ani `www.domain.com`). To odpovídá formátu Consuelo a předchází duplicitám, když připojíte synchronizaci e-mailu/kalendáře.
</Warning>
...
2. Použijte stejné e-mailové adresy, které uživatelé použili při připojení do vašeho pracovního prostoru Consuelo
...
1. Přejděte k objektu v Consuelo
...
* Consuelo začne synchronizovat e-maily k záznamům kontaktů
...
<AccordionGroup>
  <Accordion title="Mohu migrovat pracovní postupy automaticky?">
    V tuto chvíli ne. Pracovní postupy je nutné v Consuelo znovu vytvořit ručně.
  </Accordion>
...
Kontaktujte [contact@consuelo.com](mailto:contact@consuelo.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
