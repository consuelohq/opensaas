...
description: Ovládejte, které emaily se importují do Consuelo.
---

## Přehled

Ve výchozím nastavení Consuelo synchronizuje všechny externí emaily z vaší připojené poštovní schránky. Můžete omezit, co se importuje, pomocí **výběru složek** a **nastavení viditelnosti**.
