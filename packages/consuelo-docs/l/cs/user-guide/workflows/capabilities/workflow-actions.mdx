...
description: Zjistěte, jaké akce jsou k dispozici v pracovních postupech Consuelo.
---
...
<Note>
  E-maily můžete odesílat pouze z poštovních schránek synchronizovaných s vaším vlastním účtem Consuelo. Odesílání z poštovních schránek ostatních členů týmu (např. e-mail vlastníka účtu) je v plánu.
</Note>
