---
title: Vytvořte nabídku nebo fakturu z Consuelo
...
* [Vygenerovat PDF z Consuelo](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — připojte vygenerované soubory PDF k záznamům
