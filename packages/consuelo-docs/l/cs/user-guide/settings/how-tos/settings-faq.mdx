---
title: Nastavení FAQ
description: Často kladené otázky k nastavení Consuelo.
...
<AccordionGroup>
  ...
  <Accordion title="Mohu změnit svou e-mailovou adresu?">
    Chcete-li změnit svou e-mailovou adresu, kontaktujte prosím [contact@consuelo.com](mailto:contact@consuelo.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Mohu přizpůsobit doménu své pracovní oblasti?">
    ...
    * **Poddoména**: Použijte poddoménu Consuelo, například `yourcompany.consuelo.com`
