---
title: Orientace v prostředí Consuelo
...
Nabídka příkazů vám v Consuelo poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (Consuelo podporuje logické i trvalé mazání)
