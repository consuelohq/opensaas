...
description: Sledujte podrobný návod, jak se zaregistrovat na Consuelo, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Consuelo](https://app.consuelo.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@consuelo.com](mailto:contact@consuelo.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
