...
<AccordionGroup>
  <Accordion title="Jaké role jsou ve Consuelo ve výchozím nastavení?">
    Consuelo ve výchozím stavu obsahuje role **Administrátor** a **Člen**. Můžete vytvářet další vlastní role podle potřeb vašeho týmu (např. obchodní zástupce, manažer, uživatel pouze pro čtení).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Jaká oprávnění k akcím jsou k dispozici?">
    ...
    * **Odeslat e-mail**: Možnost odesílat e-maily z Consuelo
...
<AccordionGroup>
  ...
  <Accordion title="Co je zřizování Just-in-Time (JIT)?">
    Při zřizování JIT se uživatelské účty v Consuelo vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
  </Accordion>
