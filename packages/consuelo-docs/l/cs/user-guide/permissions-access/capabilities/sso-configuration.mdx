...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do Consuelo pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru Consuelo

<Note>
  **Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@consuelo.com
</Note>
...
* Odeberte je z pracovního prostoru Consuelo
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v Consuelo (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte Consuelo do svého pracovního postupu deprovisioningu
