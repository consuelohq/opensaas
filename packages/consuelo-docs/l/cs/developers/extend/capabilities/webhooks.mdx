...
Webhooky posílají data do vašich systémů v reálném čase, když v Consuelo dojde k událostem — bez potřeby průběžného dotazování. Použijte je k udržování externích systémů v synchronizaci, spouštění automatizací nebo zasílání upozornění.
...
Consuelo odesílá webhooky pro tyto typy událostí:
...
Consuelo kvůli bezpečnosti podepisuje každý požadavek webhooku. Ověřujte podpisy, abyste zajistili, že požadavky jsou autentické.
...
| **Spouštěč webhooku v pracovním postupu** | IN   | Přijímejte data do Consuelo z externích systémů                   |
