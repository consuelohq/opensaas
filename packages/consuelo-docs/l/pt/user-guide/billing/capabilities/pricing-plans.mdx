...
description: Saiba mais sobre os planos de preços do Consuelo e como alternar entre eles.
---

## Visão Geral

O Consuelo oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o Consuelo na sua própria infraestrutura sem custo:
