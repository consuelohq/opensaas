---
title: Posso enviar e-mails a partir do Consuelo?
description: Informações sobre o envio de e-mails diretamente a partir do Consuelo.
---

## Estado atual

A integração de e-mail do Consuelo foi concebida para **sincronizar e apresentar** o seu histórico de e-mails. Não é possível redigir ou enviar e-mails diretamente a partir da interface do Consuelo.
...
Embora não seja possível enviar e-mails manualmente a partir do Consuelo, **pode enviar e-mails automaticamente utilizando Fluxos de Trabalho**. Isto é útil para:
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o Consuelo a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do Consuelo está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/twentyhq/consuelo/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
