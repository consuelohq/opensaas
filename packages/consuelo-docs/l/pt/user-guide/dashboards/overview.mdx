---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no Consuelo.
...
Os painéis no Consuelo oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
  ...
  * A exportação de painéis e o compartilhamento com usuários externos (usuários não-Consuelo) não estão disponíveis no momento.
