...
description: Guia completo passo a passo para formatar seus dados para importação no Consuelo.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o Consuelo espera.
...
O Consuelo impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no Consuelo
...
* Deve ser exclusivo (sem duplicados no arquivo ou no Consuelo)
...
* Deve ser exclusivo dentro do seu arquivo e no Consuelo
...
* **Opcional**: a Consuelo gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na Consuelo
...
## Etapa 6: Garanta que os campos existam na Consuelo
