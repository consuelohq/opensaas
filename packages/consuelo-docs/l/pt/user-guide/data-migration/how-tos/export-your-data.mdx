...
description: Guia completo passo a passo para exportar dados do Consuelo.
---
...
3. **Documente os mapeamentos de campos** — observe como os campos do Consuelo se mapeiam para o seu sistema de destino
