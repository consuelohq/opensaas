...
description: Quando e como usar as APIs da Consuelo para importações de dados em larga escala.
---

## Visão Geral

A Consuelo oferece tanto **GraphQL** como **APIs REST** para a importação programática de dados. Use a API quando a importação por CSV não for prática para o seu volume de dados ou quando precisar de importações automatizadas e recorrentes.
...
A Consuelo impõe limites de taxa para assegurar a estabilidade do sistema:
...
A Consuelo suporta dois tipos de API:
...
* Verifique se os formatos correspondem aos requisitos da Consuelo (veja [Mapeamento de Campos](/l/pt/user-guide/data-migration/capabilities/field-mapping))
...
* Verifique se os dados aparecem corretamente na Consuelo
