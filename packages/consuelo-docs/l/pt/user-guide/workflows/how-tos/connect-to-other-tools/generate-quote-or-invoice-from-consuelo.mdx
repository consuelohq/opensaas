---
title: Gerar um orçamento ou fatura no Consuelo
...
* [Gerar um PDF a partir do Consuelo](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — anexar PDFs gerados aos registros
