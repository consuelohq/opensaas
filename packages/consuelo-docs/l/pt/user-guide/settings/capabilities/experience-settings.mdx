...
Personalize a sua experiência no Consuelo em **Configurações → Experiência**.
...
Selecione o idioma de sua preferência para a interface do Consuelo no menu suspenso.
