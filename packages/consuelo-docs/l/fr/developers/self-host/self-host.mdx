...
description: Déployez et gérez Consuelo sur votre propre infrastructure.
---

<Frame>
  <img src="/images/user-guide/what-is-consuelo/20.png" alt="IA" />
</Frame>

## Vue d'ensemble

Consuelo peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
