...
description: En savoir plus sur les formules tarifaires de Consuelo et comment passer de l’une à l’autre.
---

## Vue d'ensemble

Consuelo propose une tarification flexible adaptée aux équipes de toute taille, que vous préfériez l’hébergement cloud ou l’auto-hébergement.
...
Hébergez Consuelo sur votre propre infrastructure, sans frais :
...
* **Fonctionnalités premium** : intégration SSO et autorisations au niveau des lignes
* Assistance de l’équipe Consuelo
