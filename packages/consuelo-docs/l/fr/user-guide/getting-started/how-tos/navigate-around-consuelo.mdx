...
Le menu de commandes vous donne **un accès rapide aux actions** dans Consuelo. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Consuelo prend en charge les suppressions logiques et définitives)
