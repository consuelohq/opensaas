...
description: Formats de fichiers pris en charge pour l’importation de données dans Consuelo.
---

## Formats pris en charge

Consuelo prend en charge trois formats de fichiers pour l’importation :
