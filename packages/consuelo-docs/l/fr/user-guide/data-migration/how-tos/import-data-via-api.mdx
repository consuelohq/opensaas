...
description: Quand et comment utiliser les API de Consuelo pour des importations de données à grande échelle.
---

## Vue d'ensemble

Consuelo propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
Consuelo applique des limites de débit pour garantir la stabilité du système :
...
Consuelo prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de Consuelo (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans Consuelo
...
Contactez-nous à [contact@consuelo.com](mailto:contact@consuelo.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
