...
description: Guide complet étape par étape pour formater vos données en vue de leur importation dans Consuelo.
---
...
**C’est l’étape la plus importante.** Le fichier d’exemple vous indique exactement les noms de colonnes et le format attendus par Consuelo.
...
Consuelo impose l’unicité sur certains champs. Les doublons provoqueront des erreurs d’import.
...
3. Vérifiez les doublons qui existent déjà dans Consuelo
...
* Doit être unique (aucun doublon dans le fichier ni dans Consuelo)
...
* Doit être unique dans votre fichier et dans Consuelo
...
* **Liens / URL du lien**: `https://consuelo.com`
...
* **Optionnel**: Consuelo génère automatiquement des ID s’ils ne sont pas fournis
...
* L’enregistrement parent doit déjà exister dans Consuelo
...
## Étape 6: Vérifiez que les champs existent dans Consuelo
