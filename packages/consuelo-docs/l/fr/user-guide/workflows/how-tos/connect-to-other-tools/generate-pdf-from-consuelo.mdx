---
title: Générer un PDF depuis Consuelo
description: Créez un flux de travail pour générer et joindre un PDF (par exemple un devis) à un enregistrement.
---

Générez ou récupérez automatiquement un PDF et joignez-le à un enregistrement dans Consuelo. Cette fonctionnalité est couramment utilisée pour créer des devis, des factures ou des rapports liés aux Entreprises, aux Opportunités ou à d'autres objets.
...
2. Téléversement du fichier dans Consuelo
...
export const main = async (
  ...
  // Cloud: https://api.consuelo.com/graphql
  // Self-hosted: https://your-domain.com/graphql
  const graphqlEndpoint = 'https://api.consuelo.com/graphql';
...
* [Générer un devis ou une facture depuis Consuelo](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-consuelo)
