...
description: Foire aux questions sur les paramètres de Consuelo.
...
<AccordionGroup>
  ...
  <Accordion title="Puis-je changer mon adresse e-mail ?">
    Pour changer votre adresse e-mail, veuillez contacter [contact@consuelo.com](mailto:contact@consuelo.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Puis-je personnaliser le domaine de mon espace de travail ?">
    ...
    * **Sous-domaine** : Utilisez un sous-domaine Consuelo comme `yourcompany.consuelo.com`
