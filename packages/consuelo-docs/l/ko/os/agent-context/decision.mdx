...
{/* Generated from packages/os/decision.md. Do not edit this page directly. */}

> Decision-process doctrine used by Consuelo OS agents.

<Note>
This page is generated from `packages/os/decision.md`. Edit the source Markdown, then run `bun run --cwd packages/consuelo-docs generate-os-source-docs` to refresh the public docs.
</Note>
...
| Field | Value |
| --- | --- |
| Source file | `packages/os/decision.md` |
