...
description: Implementați și gestionați Consuelo pe propria infrastructură.
---

<Frame>
  <img src="/images/user-guide/what-is-consuelo/20.png" alt="AI" />
</Frame>

## Prezentare generală

Consuelo poate fi găzduit în regim propriu pe propria infrastructură, oferindu-vă control complet asupra datelor și a implementării.
