...
1. Într-un terminal, pe găzduitorul unde rulează Consuelo, opriți Consuelo: `docker compose down`.
...
3. Repuneți Consuelo în funcțiune cu comanda `docker compose up -d`.
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.55
...
Această problemă este specifică versiunii Consuelo și nu ar trebui să fie necesară pentru actualizările viitoare.
...
Ar trebui să fie mereu în intervalul versiunii Consuelo curente `major.minor`, puteți vizualiza versiunea instanței dvs. în panoul de administrare (la `/settings/admin-panel`, accesibil dacă utilizatorul dvs. are proprietatea `canAccessFullAdminPanel` setată la adevărat în baza de date) sau executând `echo $APP_VERSION` în containerul dvs. `twenty-server`.

Pentru a remedia o desincronizare a versiunii spațiului de lucru, va trebui să actualizați din versiunea corespunzătoare Consuelo urmând ghidul de actualizare relevant secvențial și așa mai departe până când ajungeți la versiunea dorită.
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.52
...
Va trebui să actualizați manual versiunea spațiului de lucru la `0.51.0` în baza de date și să actualizați utilizând versiunea consuelo `0.52.11` urmând ghidul de actualizare de mai sus.

### v0.50 la v0.51

Actualizați instanța Consuelo pentru a utiliza imaginea v0.51
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.50.0
...
Vă rugăm să actualizați docker-compose.yml-ul dvs. local cu [v0.50.0 docker-compose.yml](https://github.com/twentyhq/consuelo/blob/v0.50.0/packages/twenty-docker/docker-compose.yml)

### v0.43.0 la v0.44.0

Actualizați instanța Consuelo pentru a utiliza imaginea v0.44.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.43.0
...
2. Actualizați docker-compose.yml-ul pentru a utiliza imaginea postgres:16 din fișierul [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml).
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.42.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.41.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.40.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.35.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.34.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.33.0
...
Dacă doriți să păstrați utilizarea imaginii twenty-postgres, înlocuiți pur și simplu `Consuelo/twenty-postgres:${TAG}` cu `Consuelo/twenty-postgres` în docker-compose.yml.

### v0.31.0 la v0.32.0

Actualizați instanța Consuelo pentru a utiliza imaginea v0.32.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.31.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.30.0

**Schimbare importantă**:
Pentru a îmbunătăți performanțele, Consuelo necesită acum cache de tip Redis configurat. Am actualizat [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml) pentru a reflecta acest lucru.
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.24.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.23.0
...
Actualizați instanța Consuelo pentru a utiliza imaginea v0.22.0
