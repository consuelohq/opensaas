---
title: Generați o ofertă sau o factură din Consuelo
...
* [Generați un PDF din Consuelo](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — atașați PDF-uri generate la înregistrări
