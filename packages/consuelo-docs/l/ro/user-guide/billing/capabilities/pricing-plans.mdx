...
description: Aflați despre planurile tarifare ale Consuelo și cum să comutați între ele.
---

## Prezentare generală

Consuelo oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți Consuelo pe propria infrastructură, fără costuri:
...
* **Funcționalități premium**: integrare SSO și permisiuni la nivel de rând
* Asistență din partea echipei Consuelo
