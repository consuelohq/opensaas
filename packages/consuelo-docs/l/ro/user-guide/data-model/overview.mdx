...
Consuelo include obiecte standard:
...
Fiecare afacere funcționează diferit. Personalizarea modelului tău de date înseamnă că poți modela Consuelo în jurul proceselor **tale**, în loc să le forțezi într-un sistem rigid.

Consuelo oferă flexibilitate totală:
...
Identifică principalele concepte cu care lucrezi. Consuelo oferă deja:
