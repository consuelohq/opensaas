...
Consuelo acceptă importul relațiilor dintre obiecte în timpul importului CSV. Acest lucru vă permite să conectați înregistrări (de ex., să atașați Persoane la Companii) ca parte a migrării datelor.
...
## Cum funcționează relațiile în Consuelo

### Unu la mulți / Mulți la unu

Consuelo acceptă relații standard în care o înregistrare se leagă de multe altele:
...
Înainte de a importa partea „mulți”, înregistrările de pe partea „unu” trebuie să existe deja în Consuelo.
...
4. Consuelo va lega automat fiecare înregistrare de părintele corespunzător
...
<Note>**Conectarea la Membrii Workspace-ului**: Când relația indică către Membrii Workspace-ului (echipa dvs. care se autentifică în Consuelo), referiți-vă la ei prin **adresa de email**, nu prin nume.</Note>
