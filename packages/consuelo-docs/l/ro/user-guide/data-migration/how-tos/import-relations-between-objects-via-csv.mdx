...
Înregistrarea părinte (partea „unu”) trebuie să existe în Consuelo înainte de a o putea referi.
...
1. Exportați înregistrările părinte din Consuelo
...
<Warning>
  **Formatul domeniului contează!**
  ...
  Folosiți `https://domain.com` (nu doar `domain.com`). Acest lucru corespunde modului în care Consuelo stochează domeniile companiilor și previne erorile de potrivire.
</Warning>
...
Consuelo va lega automat fiecare înregistrare copil de părintele corespunzător.
...
| **Înregistrări inexistente**           | Înregistrarea părinte nu există în Consuelo            | Importați mai întâi înregistrările părinte sau verificați greșelile de tastare |
| **Nepotrivire de majuscule/minuscule** | `Acme.com` în fișier, dar `acme.com` în Consuelo       | Asigurați potrivirea exactă a majusculelor/minusculelor                        |
...
<AccordionGroup>
  <Accordion title="Ce se întâmplă dacă înregistrarea mea părinte nu are un domeniu sau un email?">
    ...
    1. Folosiți `id`-ul Consuelo (exportați înregistrările părinte pentru a obține ID-urile lor)
