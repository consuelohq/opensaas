...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Consuelo.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Consuelo.
...
Consuelo impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Consuelo
...
* Trebuie să fie unic (fără duplicate în fișier sau în Consuelo)
...
* Trebuie să fie unic în fișierul dvs. și în Consuelo
...
* **Opțional**: Consuelo generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Consuelo
...
## Pasul 6: Asigurați-vă că câmpurile există în Consuelo
