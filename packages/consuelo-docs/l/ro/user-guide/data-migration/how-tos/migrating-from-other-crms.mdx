...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către Consuelo.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către Consuelo. Procesul implică auditarea datelor, pregătirea spațiului de lucru Consuelo, exportul din sistemul curent și importul în Consuelo.
...
Creați un document de mapare între CRM-ul curent și Consuelo:
...
## Pasul 3: Configurați spațiul dvs. de lucru Consuelo

Înainte de a importa date, pregătiți spațiul dvs. de lucru Consuelo:
...
<Warning>
  **Invitați utilizatorii ÎNAINTE de a importa datele.**
  ...
  Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în Consuelo înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru Consuelo.
...
3. Verificați că nu există deja duplicate în Consuelo
...
<Warning>
  **Formatul domeniului este critic.**
  ...
  Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului Consuelo și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru Consuelo
...
1. Navigați la obiect în Consuelo
...
* Consuelo va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în Consuelo.
  </Accordion>
