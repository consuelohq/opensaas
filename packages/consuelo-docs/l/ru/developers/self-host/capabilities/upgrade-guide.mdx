...
1. В терминале на хосте, где работает Consuelo, отключите Consuelo: `docker compose down`.
...
3. Верните Consuelo в сеть с `docker compose up -d`.
...
Обновите вашу инстанцию Consuelo для использования изображения v0.55
...
Эта проблема специфична для данной версии Consuelo и не должна требоваться для будущих обновлений.
...
Она всегда должна находиться в диапазоне текущей версии вашего инстанции Consuelo `major.minor`, вы можете просмотреть версию инстанции в админ-панели (на `/settings/admin-panel`, доступна, если свойство `canAccessFullAdminPanel` вашего пользователя установлено на true в базе данных) или запустив `echo $APP_VERSION` в вашем контейнере `twenty-server`.

Чтобы исправить десинхронизированную версию рабочего пространства, вам потребуется обновить его с соответствующей версии Consuelo, следуя последовательному руководству по обновлению и так далее, пока он не достигнет желаемой версии.
...
Обновите вашу инстанцию Consuelo для использования изображения v0.52
...
Вам потребуется вручную обновить версию рабочего пространства до `0.51.0` в базе данных и обновить с использованием версии consuelo `0.52.11`, следуя её руководству по обновлению.

### v0.50 до v0.51

Обновите вашу инстанцию Consuelo для использования изображения v0.51
...
Обновите вашу инстанцию Consuelo для использования изображения v0.50.0
...
Обновите ваш локальный `docker-compose.yml` с [v0.50.0 docker-compose.yml](https://github.com/twentyhq/consuelo/blob/v0.50.0/packages/twenty-docker/docker-compose.yml)

### v0.43.0 до v0.44.0

Обновите вашу инстанцию Consuelo для использования изображения v0.44.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.43.0
...
2. Обновите ваш файл docker-compose.yml с использованием изображения postgres:16, как в файле [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml).
...
Обновите вашу инстанцию Consuelo для использования изображения v0.42.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.41.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.40.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.35.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.34.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.33.0
...
Если вы хотите продолжать использовать изображение twenty-postgres, просто замените `Consuelo/twenty-postgres:${TAG}` на `Consuelo/twenty-postgres` в файле docker-compose.yml.

### v0.31.0 до v0.32.0

Обновите вашу инстанцию Consuelo для использования изображения v0.32.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.31.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.30.0

**Критически важное изменение**:
Чтобы повысить производительность, Consuelo теперь требует настроить кэш Redis. Мы обновили [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/consuelo/main/packages/twenty-docker/docker-compose.yml) для этого.
...
Обновите вашу инстанцию Consuelo для использования изображения v0.24.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.23.0
...
Обновите вашу инстанцию Consuelo для использования изображения v0.22.0
