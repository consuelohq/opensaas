...
Флаги функций используются для скрытия экспериментальных функций. Для Consuelo они устанавливаются на уровне рабочей области, а не на уровне пользователя.
