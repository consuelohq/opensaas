---
title: اكتشف Consuelo
description: مرحباً بك في دليل مستخدم Consuelo، مصادرك للإعدادات المتقدمة وأفضل الممارسات.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={٣}>
  <Card href="/l/ar/user-guide/getting-started/capabilities/what-is-consuelo" img="/images/user-guide/api/api.png">
    <CardTitle>اكتشف Consuelo</CardTitle>
    تعرّف على ماهية Consuelo وكيف يمكن أن تساعد عملك.
  </Card>
