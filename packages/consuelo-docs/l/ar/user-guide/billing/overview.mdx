---
title: الفوترة
description: تعرّف على تسعير Consuelo وأدِر اشتراكك.
...
تقدّم Consuelo خطط تسعير مرنة لتلبية احتياجات فريقك. أدِر اشتراكك، وتتبع أرصدة سير العمل، واطّلع على الفواتير — وكل ذلك من **Settings → Billing**.

## ما الذي يتضمنه هذا القسم

<CardGroup cols={٢}>
  <Card title="خطط التسعير" icon="tags" href="/l/ar/user-guide/billing/capabilities/pricing-plans">
    تعرّف على خطط تسعير Consuelo وما تتضمنه.
  </Card>
...
| **المؤسسة (مستضاف ذاتيًا)** | كل ما في Pro + ميزات Premium (SSO وأذونات على مستوى الصف)، دعم فريق Consuelo، ولا يُشترط نشر شيفرتك المخصصة كمصدر مفتوح قبل التوزيع |
...
**هل يمكنني استخدام Consuelo مجانًا؟**
نعم! استضف Consuelo ذاتيًا واحصل على جميع ميزات Pro دون تكلفة.
