...
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل Consuelo محلياً.
---
...
<Tabs>
  <Tab title="Linux و MacOS">
    قبل أن تتمكن من تثبيت واستخدام Consuelo، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب Consuelo مخزن بيانات Redis لتقديم أفضل أداء
...
## الخطوة الثامنة: استخدم Consuelo

**الواجهة الأمامية**

ستكون واجهة Consuelo الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم Consuelo متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
