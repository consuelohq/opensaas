---
title: 貢献
description: Consueloのオープンソース開発に貢献しましょう。
---
...
Consueloはオープンソースであり、コミュニティからの貢献を歓迎しています。 バグを修正したり、機能を追加したり、ドキュメントを改善したりするなど、あなたの貢献は、Consueloをすべての人にとってより良いものにする助けになります。
