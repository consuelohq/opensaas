---
title: 拡張
description: API、Webhook、カスタムアプリで Consuelo の機能を拡張できます。
---
...
Consuelo は拡張性を念頭に設計されています。 当社の API、Webhook、アプリフレームワークを使用して既存のツールと統合し、カスタム機能を構築できます。

## 現在できること

* **API**: REST または GraphQL を使用して、プログラムから CRM データをクエリおよび変更します。
* **ウェブフック**: Consuelo でイベントが発生したときにリアルタイム通知を受信します。
* **アプリ**: Consuelo の機能を拡張するカスタムアプリケーションを構築 - 近日公開！

## 始めに

<CardGroup cols={2}>
  <Card title="API" icon="コード" href="/l/ja/developers/extend/capabilities/apis">
    プログラムから Consuelo に接続
  </Card>
