...
* [Consuelo から PDF を生成する](/l/ja/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — 生成された PDF をレコードに添付する
