...
| **Custom integrations** | Your app → Consuelo automation |
...
3. You'll receive a unique webhook URL like:
   ```
   https://api.consuelohq.com/webhooks/workflow/abc123...
   ```
...
**Using cURL**:
```bash
curl -X POST https://api.consuelohq.com/webhooks/workflow/abc123... \
