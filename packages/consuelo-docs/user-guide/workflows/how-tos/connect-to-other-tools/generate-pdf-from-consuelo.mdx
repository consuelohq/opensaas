---
title: Generate a PDF from Consuelo
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in Consuelo. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
2. Uploading the file to Consuelo
...
export const main = async (
  ...
  // Replace with your Consuelo GraphQL endpoint
  // Cloud: https://api.consuelohq.com/graphql
  // Self-hosted: https://your-domain.com/graphql
  const graphqlEndpoint = 'https://api.consuelohq.com/graphql';
...
- [Generate a Quote or Invoice from Consuelo](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-consuelo)
