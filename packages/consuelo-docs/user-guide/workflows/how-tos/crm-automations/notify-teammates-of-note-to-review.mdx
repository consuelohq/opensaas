...
You want to tag a colleague in a note so they receive a notification to review it. Today, Consuelo doesn't support @mentions in notes or tasks.
...
View the note here:
https://yourSubDomain.consuelohq.com/object/note/{{recordIsUpdated.id}}
...
<Note>
Replace `yourSubDomain` with your actual Consuelo workspace subdomain.
</Note>
