...
Single Sign-On (SSO) allows your team members to log into Consuelo using your organization's identity provider. This provides:
...
- Admin access to Consuelo workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@consuelohq.com
</Note>
...
- Remove them from the Consuelo workspace
...
- **Group mapping**: Map IdP groups to Consuelo roles (if available)
- **Offboarding process**: Include Consuelo in your deprovisioning workflow
