...
Consuelo comes with standard objects:
- **People** — individuals (contacts, leads, partners)
- **Companies** — organizations
- **Opportunities** — deals or sales
- **Files** — documents, recordings, scripts, agent configs, and any persistent content
...
Every business works differently. Customizing your data model means you can shape Consuelo around **your** processes instead of forcing yours into a rigid system.

Consuelo offers full flexibility:
...
Identify the main concepts you work with. Consuelo already provides:
