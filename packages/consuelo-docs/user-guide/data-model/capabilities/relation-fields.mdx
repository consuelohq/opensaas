...
Many-to-many relations use a **junction object** pattern: an intermediate object that connects both sides. With the junction relation feature, Consuelo displays the final linked records directly, hiding the intermediate object from the UI.
...
Consuelo comes with pre-built relations between standard objects:
