...
description: Complete step-by-step guide to format your data for import into Consuelo.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Consuelo expects.
...
Consuelo enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Consuelo
...
- Must be unique (no duplicates in file or in Consuelo)
...
- Must be unique within your file and in Consuelo
...
### ID Fields
- **Optional**: Consuelo auto-generates IDs if not provided
...
- The parent record must already exist in Consuelo
...
## Step 6: Ensure Fields Exist in Consuelo
