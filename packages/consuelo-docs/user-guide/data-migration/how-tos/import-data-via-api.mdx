...
description: When and how to use Consuelo's APIs for large-scale data imports.
---

## Overview

Consuelo provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Consuelo enforces rate limits to ensure system stability:
...
Consuelo supports two API types:
...
- Verify formats match Consuelo's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Consuelo
...
Contact us at [contact@consuelohq.com](mailto:contact@consuelohq.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
