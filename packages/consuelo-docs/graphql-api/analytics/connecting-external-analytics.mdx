...
See [Import Automation](/graphql-api/general/import-automation) for detailed patterns.
...
2. **Scheduled exports:** Use [Scheduled Reports](/graphql-api/analytics/scheduled-reports)
...
- [Growth Metrics Dashboards](/graphql-api/analytics/growth-metrics-dashboards)
