...
1. In a terminal, on the host where Consuelo is running, turn off Consuelo: `docker compose down`
...
3. Bring Consuelo back online with `docker compose up -d`
...
Upgrade your Consuelo instance to use v0.55 image
...
This issue is specific to this Consuelo version and should not be required for future upgrades.
...
Upgrade your Consuelo instance to use v0.52 image
...
You will have to manually update your workspace version to `0.51.0` in database and upgrade using consuelo version `0.52.11` following its just above upgrade guide.


### v0.50 to v0.51

Upgrade your Consuelo instance to use v0.51 image
...
Upgrade your Consuelo instance to use v0.50.0 image
...
Upgrade your Consuelo instance to use v0.44.0 image
...
Upgrade your Consuelo instance to use v0.43.0 image
...
Upgrade your Consuelo instance to use v0.42.0 image
...
Upgrade your Consuelo instance to use v0.41.0 image
...
Upgrade your Consuelo instance to use v0.40.0 image
...
Upgrade your Consuelo instance to use v0.35.0 image
...
Upgrade your Consuelo instance to use v0.34.0 image
...
Upgrade your Consuelo instance to use v0.33.0 image
...
Upgrade your Consuelo instance to use v0.32.0 image
...
Upgrade your Consuelo instance to use v0.31.0 image
...
Upgrade your Consuelo instance to use v0.30.0 image

**Breaking change**:
To enhance performances, Consuelo now requires redis cache to be configured. We have updated our [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/twenty/main/packages/twenty-docker/docker-compose.yml) to reflect this.
...
Upgrade your Consuelo instance to use v0.24.0 image
...
Upgrade your Consuelo instance to use v0.23.0 image
...
Upgrade your Consuelo instance to use v0.22.0 image
