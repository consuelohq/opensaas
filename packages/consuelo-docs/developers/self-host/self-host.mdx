---
title: Self-Host
description: Deploy and manage Consuelo on your own infrastructure.
---
<Frame>
...
Consuelo can be self-hosted on your own infrastructure, giving you full control over your data and deployment.
