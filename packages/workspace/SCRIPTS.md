...
Use `tddPhase: "red" | "green" | "post"` on task-scoped command validation when a focused test run should be copied into the corresponding server-managed TDD evidence section.
