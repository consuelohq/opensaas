...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    body { margin: 0; min-height: 100vh; background: #070708; color: #f2eee6; font-size: 13px; line-height: 1.35; font-weight: 400; letter-spacing: 0.02em; } @media (max-width: 1024px) { body { font-size: clamp(10.5px, 2.68vw, 13px); line-height: 1.36; } main { padding: clamp(20px, 4.8vw, 32px) clamp(10px, 2.5vw, 24px); } .block { margin: 24px 0; } .rule { margin: 24px 0; } li { margin: 2.2px 0; } } @media (max-width: 430px) { body { font-size: clamp(10.1px, 2.47vw, 11.8px); line-height: 1.34; } main { padding: 22px 10px; } li, .blog-item { white-space: nowrap; } }
