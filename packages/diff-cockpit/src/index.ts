    ...
    <section id="diff-command-palette" class="command-palette command-bottom-drawer" data-command-palette role="dialog" aria-modal="true" aria-labelledby="diff-command-title" hidden>
      <div class="command-panel">
        ...
        <div class="command-section"><p class="command-section-title">Page</p><div class="command-list" data-command-pages>
          ...
          <button class="command-item" type="button" data-command-page data-command-label="Go to: Main code" data-command-url="${escapeAttribute(mainCodePath)}"><span class="command-key">GC</span><span><strong>Go to: Main code</strong><small>Open the main code browser.</small></span></button>
...
const state = { data: null, selected: null, diffModule: null, treeModule: null, activeFile: null, inlineCommentsVisible: true, currentView: false, observer: null, scrollHandler: null, diffRenderVersion: 0, renderedFileCount: 0, collapsedFolders: new Set(), expandedReviewItems: new Set(), drawerSections: { status: true, summary: true, prompt: false, checks: false, comments: false, commits: false } };
