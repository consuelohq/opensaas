...
describe('Sites CLI', () => {
  it('prints, refreshes, opens, and reports the local Sites paths', () => {
    ...
    expect(tracesHtml).toContain('<title>Traces - Observability</title>');
    expect(tracesHtml).toContain('class="trace-shell"');
    expect(tracesHtml).toContain('placeholder="Search traces..."');
    expect(tracesHtml).toContain('/gateway/traces/recent');
    expect(tracesHtml).toContain('/gateway/traces/events');
    expect(tracesHtml).not.toContain('Live tracing cockpit');
    expect(tracesHtml).not.toContain('data-trace-modal');
    expect(tracesHtml).not.toContain('data-inspector');
