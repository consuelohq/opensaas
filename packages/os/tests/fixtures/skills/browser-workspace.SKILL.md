...
workspace.call({ tool: "browser.headed", input: { url: "<url>" } })
workspace.call({ tool: "browser.status", input: {} })
...
workspace.call({ tool: "browser.headed", input: { url: "<url>" }, timeout: 300000 })
