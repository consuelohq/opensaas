...
include both the agent-facing workspace.call(...) command and the CLI bun ... context.js ... command for retrieval
...
include both typed workspace.call(...) examples and CLI bun ... commands where retrieval or save needs terminal access
...
When saving context via workspace.call({ tool: "context.save", ... }) or bun packages/workspace/scripts/context.js save, prepend a tags: line at the top of the content. This makes memories searchable by concept even when the title is generic.
