...
export const schemaTypeSignatures: Record<string, string> = {
  ...
  GoogleInput: '{ action: "status" | "connect" | "run"; args?: string[]; account?: string; mode?: "read" | "write"; approved?: boolean; approvalReason?: string; timeoutMs?: number; dryRun?: boolean; requestId?: string; taskSession?: string }',
