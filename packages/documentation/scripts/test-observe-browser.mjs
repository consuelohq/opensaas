...
try {
  ...
  for (const viewport of [
    ...
    if (viewport.name === 'mobile') {
      ...
      if (!(await page.locator('#starlight__sidebar').getByRole('link', { name: 'Debugging failures', exact: true }).isVisible())) throw new Error('Observe navigation is unavailable on mobile');
