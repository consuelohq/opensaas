...
export const legacyRedirects = {
  ...
  '/connect/connectors/additional-connectors': '/connect/apps-and-services/create-your-own/',
  '/connect/agents/other-agents': '/connect/agents/create-your-own/',
  '/connect/apps-and-services/additional-services': '/connect/apps-and-services/create-your-own/',
  ...
  '/os/concepts/local-and-cloud': '/nodes/',
  '/start/local-and-consuelo-cloud': '/nodes/',
  '/connect/nodes/how-nodes-work': '/nodes/',
  '/connect/nodes/home-node': '/nodes/',
  '/connect/nodes/local-nodes': '/nodes/local/',
  '/connect/nodes/cloud-nodes': '/nodes/cloud/',
  '/os/concepts/data-model-and-graphql': '/reference/',
  '/os/tools/subagents': '/tools/subagents/',
  ...
  '/user-guide/getting-started/capabilities/implementation-services': '/start/',
  '/user-guide/getting-started/capabilities/glossary': '/reference/glossary/',
  '/user-guide/getting-started/capabilities/keyboard-shortcuts': '/start/',
  '/user-guide/getting-started/how-tos/navigate-around-consuelo': '/start/',
  '/user-guide/getting-started/how-tos/configure-your-workspace': '/reference/configuration/',
  '/developers/introduction': '/reference/',
  '/developers/agent/overview': '/tools/',
  '/developers/agent/crm-tools': '/connect/apps-and-services/',
  '/developers/api/overview': '/reference/',
  '/developers/api/auth': '/secure/',
  '/developers/api/graphql': '/reference/',
  '/developers/api/contacts': '/connect/apps-and-services/',
  '/developers/api/voice': '/connect/apps-and-services/',
  '/consuelo-ui/display/app-tooltip': '/reference/',
  '/consuelo-ui/display/checkmark': '/reference/',
  '/consuelo-ui/display/chip': '/reference/',
  '/consuelo-ui/display/icons': '/reference/',
  '/consuelo-ui/display/soon-pill': '/reference/',
  '/consuelo-ui/display/tag': '/reference/',
  '/consuelo-ui/input/block-editor': '/reference/',
  '/consuelo-ui/input/buttons': '/reference/',
  '/consuelo-ui/input/checkbox': '/reference/',
  '/consuelo-ui/input/color-scheme': '/reference/',
  '/consuelo-ui/input/icon-picker': '/reference/',
  '/consuelo-ui/input/image-input': '/reference/',
  '/consuelo-ui/input/radio': '/reference/',
  '/consuelo-ui/input/select': '/reference/',
  '/consuelo-ui/input/text': '/reference/',
  '/consuelo-ui/input/toggle': '/reference/',
  '/consuelo-ui/introduction': '/reference/',
  '/consuelo-ui/navigation': '/reference/',
  '/consuelo-ui/navigation/breadcrumb': '/reference/',
  '/consuelo-ui/navigation/links': '/reference/',
  '/consuelo-ui/navigation/menu-item': '/reference/',
  '/consuelo-ui/navigation/navigation-bar': '/reference/',
  '/consuelo-ui/navigation/step-bar': '/reference/',
  '/consuelo-ui/progress-bar': '/reference/',
  '/graphql-api/analytics/connecting-external-analytics':
    '/reference/',
  '/graphql-api/analytics/growth-metrics-dashboards': '/reference/',
  '/graphql-api/analytics/scheduled-reports': '/reference/',
  '/graphql-api/automation/data-cleanup-automation': '/reference/',
  '/graphql-api/automation/internal-workflows-overview':
    '/reference/',
  '/graphql-api/automation/lead-scoring-setup': '/reference/',
  '/graphql-api/automation/slack-notifications': '/reference/',
  '/graphql-api/general/bulk-update-script': '/reference/',
  '/graphql-api/general/export-analytics': '/reference/',
  '/graphql-api/general/import-automation': '/reference/',
  '/graphql-api/general/internal-api-access': '/reference/',
  '/graphql-api/general/rate-limits-and-best-practices':
    '/reference/',
  '/graphql-api/getting-started/setting-up-internal-workspace':
    '/reference/',
  '/graphql-api/overview': '/reference/',
  '/graphql-api/troubleshooting/common-ops-issues': '/reference/',
  ...
  '/user-guide/graphql-api/overview': '/reference/',
