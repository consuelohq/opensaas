...
evidence:
  - source: packages/os/manifests/generated/tool.manifest.json
    ...
    runtime: Generated from all 154 named tools in the checked-in manifest and reconciled with the current subagent schema on 2026-08-12.
---

This page lists all **154 tools** in the current generated Consuelo OS manifest, alphabetically. Use **On this page** on the right as the fast index: every tool below is a real heading, so you can jump directly to it.
...
Category: `composed` · Access: `mutating` · Core tool
...
Category: `utilities` · Access: `mixed/unspecified`
...
Category: `codemode` · Access: `mutating` · Core tool
...
Category: `decision engine` · Access: `read-only` · Core tool

## `fs.apply_patch`

apply an anchored patch file with embedded task-worktree-relative paths

Category: `filesystem` · Access: `mutating` · Core tool
...
Category: `github` · Access: `mutating` · Core tool
...
Category: `media` · Access: `mixed/unspecified`
...
Category: `memory` · Access: `mutating` · Core tool
...
Category: `review` · Access: `read-only` · Core tool
...
Category: `stream` · Access: `read-only` · Core tool
...
Category: `stream` · Access: `mutating` · Core tool
...
Category: `task lifecycle` · Access: `mutating` · Core tool
...
Category: `utilities` · Access: `mutating` · Core tool

## `tools.search`

search workspace tools by intent and return ranked usage guidance

Category: `tooling` · Access: `read-only` · Core tool
