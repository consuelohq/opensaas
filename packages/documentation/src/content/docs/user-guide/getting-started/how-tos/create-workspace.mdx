...
description: Follow a step-by-step guide on how to register on Consuelo, choose a subscription plan, and set up your account.
---

import VimeoEmbed from '../../../../../components/mintlify/VimeoEmbed.astro';


## Step 1: Registration
1. Navigate to [Consuelo Sign Up](https://app.consuelohq.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@consuelohq.com](mailto:contact@consuelohq.com) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
