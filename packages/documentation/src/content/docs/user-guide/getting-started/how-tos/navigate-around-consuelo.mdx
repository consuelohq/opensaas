---
title: Navigate Around Consuelo
...
The command menu gives you **quick access to actions** in Consuelo. You can access it in two ways:
...
- Create new views
- Access deleted records (Consuelo supports soft and hard deletes)
...
If you're new to Views, read our [Views & Pipelines guide](/tools/sites/overview/) to learn how to create and customize them.
