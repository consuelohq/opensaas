...
description: "Every business works differently. Start with these 3 steps to shape Consuelo around your needs."
---

import Note from '../../../../../components/mintlify/Note.astro';


<Note>**Quick Win**: Start with connecting your mailbox. This gives you immediate value and helps your team see Consuelo in action with real data. You can do so under Settings → Accounts.</Note>

## 1. Customize your data model
Consuelo offers the flexibility you need to shape the data model that will best support your day-to-day.
...
Read [this article](/os/concepts/data-model-and-graphql/) to learn how to design your data model.

## 2. Bring your data in
Bringing your existing data into Consuelo gives your team context from the start.

### Connect your mailbox
If you have not done so when creating your workspace, connect your **Google or Microsoft account** under Settings → Accounts. This allows Consuelo to:
...
Read [this article](/developers/api/overview/) to learn more about data import.
...
## What's next?
Start creating automations using [workflows](/build/skills/how-skills-work/).
