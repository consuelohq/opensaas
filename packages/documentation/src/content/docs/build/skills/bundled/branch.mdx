---
title: "Branch"
description: "Turn large phases, epics, migrations, or planning sessions into a dependency graph of compact work IDs so focused chats and agents can manage context, execute safe sequential and parallel lanes, and rejoin through one required finalization node."
status: preview
...
Turn large phases, epics, migrations, or planning sessions into a dependency graph of compact work IDs so focused chats and agents can manage context, execute safe sequential and parallel lanes, and rejoin through one required finalization node.
