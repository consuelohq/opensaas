...
const resolvedSurface = resolveLeadConnectorSurface(window.location.pathname);
if (resolvedSurface === 'customer')
  throw new Error('Customer entry must use the isolated public bootstrap');
