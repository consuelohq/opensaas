...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  // Queue fields
  listStatus: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      type: FieldMetadataType.SELECT,
      label: 'Status',
      description: 'Queue status of the list',
      icon: 'IconPlayerPlay',
      isNullable: false,
      defaultValue: "'IDLE'",
      options: [
        { value: 'IDLE', label: 'Idle', position: 0, color: 'gray' },
  ...
  ordering: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'ordering',
      type: FieldMetadataType.SELECT,
      label: 'Ordering',
      description: 'How contacts are ordered in the queue',
  ...
  currentIndex: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
  ...
  contactCount: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
  ...
  sessionStartedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'When the current dialing session started',
      icon: 'IconPlayerPlay',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  sessionEndedAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'When the current dialing session ended',
      icon: 'IconPlayerStop',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  elapsedSeconds: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      ...
      description: 'Total elapsed seconds across all sessions',
      icon: 'IconClock',
      isNullable: true,
      defaultValue: 0,
    },
  ...
  members: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      fieldName: 'members',
      label: 'Members',
      description: 'List members in this list',
      icon: 'IconUsers',
      isNullable: true,
