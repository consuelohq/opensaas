...
>): Record<AllStandardObjectFieldName<'attachment'>, FlatFieldMetadata> => ({
  ...
  fileCategory: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      options: [
        ...
        { value: 'SCRIPT', label: 'Script', position: 9, color: 'green' },
        {
          value: 'AGENT_FILE',
          label: 'Agent File',
          position: 10,
        ...
        { value: 'FOLDER', label: 'Folder', position: 11, color: 'gray' },
      ],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  expiresAt: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.DATE_TIME,
      label: 'Expires at',
      description: 'Date when the file expires and should be deleted',
      icon: 'IconClock',
      isNullable: true,
      settings: {
        displayFormat: DateDisplayFormat.RELATIVE,
