...
const methodologies: MethodologySeed[] = [
  {
    ...
    name: 'MEDDIC',
    description:
      'Enterprise qualification framework focusing on Metrics, Economic Buyer, Decision Criteria, Decision Process, Identify Pain, and Champion.',
    systemPrompt: [
    ...
    qualificationCriteria: [
      {
        key: 'metrics',
        label: 'Metrics',
        description: 'Quantifiable business outcomes the prospect expects',
        scoringGuide:
          '0: unknown, 5: vague goals, 10: specific KPIs with baselines',
      },
      {
        key: 'economic_buyer',
        label: 'Economic Buyer',
        description:
          'Person with final budget authority identified and engaged',
        scoringGuide:
          '0: unknown, 5: identified but no access, 10: direct relationship',
      },
      {
        key: 'decision_criteria',
        label: 'Decision Criteria',
        description:
          'Technical, business, and cultural factors driving the decision',
        scoringGuide:
          '0: unknown, 5: partial list, 10: full criteria with weights',
      },
      {
        key: 'decision_process',
        label: 'Decision Process',
        description:
          'Steps, timeline, and stakeholders in the approval process',
        scoringGuide:
          '0: unknown, 5: rough timeline, 10: mapped with dates and owners',
      },
      {
        key: 'identify_pain',
        label: 'Identify Pain',
        description: 'Core business pain that justifies action and budget',
        scoringGuide:
          '0: no pain identified, 5: surface-level pain, 10: quantified cost of inaction',
      },
      {
        key: 'champion',
        label: 'Champion',
        ...
        scoringGuide:
          '0: no champion, 5: friendly contact, 10: proven advocate with influence',
      },
    ],
    scoringWeights: {
      metrics: 0.17,
    ...
    qualificationCriteria: [
      {
        key: 'budget',
        label: 'Budget',
        description: 'Prospect has allocated budget or a clear path to funding',
        scoringGuide:
          '0: no budget discussion, 5: ballpark range, 10: approved budget confirmed',
      },
      {
        key: 'authority',
        label: 'Authority',
        description: 'Decision-maker identified and engaged in the process',
        scoringGuide:
          '0: unknown buyer, 5: influencer only, 10: decision-maker engaged',
      },
      {
        key: 'need',
        label: 'Need',
        description: 'Genuine business need that your solution addresses',
        scoringGuide:
          '0: no clear need, 5: nice-to-have, 10: critical business requirement',
      },
      {
        key: 'timeline',
        label: 'Timeline',
        description: 'Defined purchase window or urgency to act',
        scoringGuide:
          '0: no timeline, 5: sometime this year, 10: specific date with consequences',
      },
    ],
    scoringWeights: {
      budget: 0.25,
  ...
  },
  {
    ...
    name: 'Challenger',
    description:
      'Methodology based on teaching, tailoring, and taking control of the sales conversation.',
    systemPrompt: [
    ...
    qualificationCriteria: [
      {
        ...
        label: 'Teach',
        description:
          "Delivering unique insights that reframe the prospect's thinking",
        scoringGuide:
          '0: no insight shared, 5: generic value prop, 10: prospect had an aha moment',
      },
      {
        key: 'tailor',
        label: 'Tailor',
        description:
          'Message adapted to the specific stakeholder and their priorities',
        scoringGuide:
          '0: generic pitch, 5: some personalization, 10: deeply relevant to their role',
      },
      {
        key: 'take_control',
        label: 'Take Control',
        description: 'Assertively guiding the conversation and next steps',
        scoringGuide:
          '0: passive, 5: suggests next steps, 10: drives timeline and commitments',
      },
    ],
    scoringWeights: null,
  },
  {
    ...
    name: 'SPIN',
    description:
      'Discovery framework using Situation, Problem, Implication, and Need-Payoff questions.',
    systemPrompt: [
    ...
    qualificationCriteria: [
      {
        key: 'situation',
        label: 'Situation',
        description: "Facts about the prospect's current state gathered",
        scoringGuide:
          '0: no context, 5: basic facts, 10: deep understanding of their environment',
      },
      {
        key: 'problem',
        label: 'Problem',
        description:
          'Difficulties and challenges uncovered through questioning',
        scoringGuide:
          '0: no problems surfaced, 5: surface issues, 10: root causes identified',
      },
      {
        key: 'implication',
        label: 'Implication',
        description: 'Consequences and ripple effects of problems explored',
        scoringGuide:
          '0: not explored, 5: some impact discussed, 10: full cost of inaction quantified',
      },
      {
        key: 'need_payoff',
        label: 'Need-Payoff',
        description: 'Prospect articulates the value of solving the problem',
        scoringGuide:
          '0: rep stated value, 5: prospect agrees, 10: prospect champions the solution',
      },
    ],
    scoringWeights: null,
  },
  {
    ...
    name: 'Sandler',
    description:
      'Qualification through Pain, Budget, and Decision discovery in a consultative framework.',
    systemPrompt: [
    ...
    qualificationCriteria: [
      {
        ...
        label: 'Pain',
        description:
          'Real pain uncovered at surface, business, and personal levels',
        scoringGuide:
          '0: no pain, 5: surface pain only, 10: personal impact articulated by prospect',
      },
      {
        key: 'budget',
        label: 'Budget',
        description:
          'Prospect can and will invest to solve the identified pain',
        scoringGuide:
          '0: no budget discussion, 5: willing but unconfirmed, 10: budget allocated',
      },
      {
        key: 'decision',
        label: 'Decision',
        description: 'Full decision process mapped with stakeholders and steps',
        scoringGuide:
          '0: unknown process, 5: partial map, 10: all steps and stakeholders confirmed',
      },
    ],
    scoringWeights: null,
  },
...
export class SeedBuiltInMethodologies1771780100001 implements MigrationInterface {
