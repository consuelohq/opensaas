...
export const DOCUMENTATION_PATHS = {
  ...
  OS_AGENT_INTERFACE_CALL: '/os/agent-interface/call',
  OS_AGENT_INTERFACE_GET_DEV_STEERING: '/os/agent-interface/get-dev-steering',
  ...
  OS_DATA_LAYER_GRAPHQL_FACADES: '/os/data-layer/graphql-facades',
  OS_DATA_LAYER_STRUCTURED_QUERIES: '/os/data-layer/structured-queries',
  OS_DATA_LAYER_VECTORIZED_CONTEXT: '/os/data-layer/vectorized-context',
  OS_INTEGRATIONS_GHL: '/os/integrations/ghl',
  OS_INTEGRATIONS_GOOGLE_ADS: '/os/integrations/google-ads',
  OS_INTEGRATIONS_META_ADS: '/os/integrations/meta-ads',
  OS_INTEGRATIONS_S3_S3_FILES: '/os/integrations/s3-s3-files',
  OS_INTEGRATIONS_SENTRY_POSTHOG: '/os/integrations/sentry-posthog',
  OS_INTEGRATIONS_STRIPE: '/os/integrations/stripe',
  OS_INTEGRATIONS_SUPABASE_AUTH: '/os/integrations/supabase-auth',
  OS_INTEGRATIONS_TWILIO: '/os/integrations/twilio',
  OS_OVERVIEW_ARCHITECTURE: '/os/overview/architecture',
  OS_OVERVIEW_CORE_CONCEPTS: '/os/overview/core-concepts',
  OS_OVERVIEW_QUICKSTART: '/os/overview/quickstart',
  OS_OVERVIEW_WHAT_IS_CONSUELO_OS: '/os/overview/what-is-consuelo-os',
  OS_PILOT_DEMO_FLOW: '/os/pilot/demo-flow',
  OS_PILOT_INSURANCE_REVENUE_WORKSPACE: '/os/pilot/insurance-revenue-workspace',
  OS_PILOT_SETUP_CHECKLIST: '/os/pilot/setup-checklist',
  OS_PILOT_SUCCESS_CRITERIA: '/os/pilot/success-criteria',
  OS_RUNBOOKS_CAMPAIGN_BRIEF: '/os/runbooks/campaign-brief',
  OS_RUNBOOKS_DAILY_REVENUE_BRIEF: '/os/runbooks/daily-revenue-brief',
  OS_RUNBOOKS_FOLLOW_UP_GENERATOR: '/os/runbooks/follow-up-generator',
  OS_RUNBOOKS_GOOGLE_ADS_REVIEW: '/os/runbooks/google-ads-review',
  OS_RUNBOOKS_LANDING_PAGE_BUILDER: '/os/runbooks/landing-page-builder',
  OS_RUNBOOKS_LEAD_PRIORITIZER: '/os/runbooks/lead-prioritizer',
  OS_RUNBOOKS_META_ADS_REVIEW: '/os/runbooks/meta-ads-review',
  OS_RUNBOOKS_OVERVIEW: '/os/runbooks/overview',
  OS_RUNBOOKS_POST_CALL_ANALYSIS: '/os/runbooks/post-call-analysis',
  OS_RUNBOOKS_SALES_COACHING: '/os/runbooks/sales-coaching',
  OS_RUNBOOKS_WEEKLY_MANAGER_REPORT: '/os/runbooks/weekly-manager-report',
  OS_RUNTIME_BUN_RUNTIME: '/os/runtime/bun-runtime',
  OS_RUNTIME_OPERATOR_SCRIPTS: '/os/runtime/operator-scripts',
  OS_RUNTIME_PACKAGE_SCRIPTS_VS_MCP_TOOLS:
    '/os/runtime/package-scripts-vs-mcp-tools',
  OS_RUNTIME_SANDBOX_EXECUTOR: '/os/runtime/sandbox-executor',
  OS_RUNTIME_SCHEDULED_RUNBOOKS: '/os/runtime/scheduled-runbooks',
  ...
  OS_WORKSPACE_FILESYSTEM_OVERVIEW: '/os/workspace-filesystem/overview',
  OS_WORKSPACE_FILESYSTEM_REPORTS: '/os/workspace-filesystem/reports',
  OS_WORKSPACE_FILESYSTEM_RUNBOOK_OUTPUTS:
    '/os/workspace-filesystem/runbook-outputs',
  OS_WORKSPACE_FILESYSTEM_S3_FILES_PRODUCTION_TARGET:
    '/os/workspace-filesystem/s3-files-production-target',
