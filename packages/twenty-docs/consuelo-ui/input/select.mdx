---
title: Select
image: /images/user-guide/what-is-consuelo/20.png
---
<Frame>
  <img src="/images/user-guide/what-is-consuelo/20.png" alt="Header" />
</Frame>
...
import { IconConsueloStar } from 'twenty-ui/display';
  ...
  return (
    <RecoilRoot>
      <Select
        ...
        options={[
          { value: 'option1', label: 'Option A', Icon: IconConsueloStar },
          { value: 'option2', label: 'Option B', Icon: IconConsueloStar },
        ]}
        value="option1"
      />
    </RecoilRoot>
