...
<AccordionGroup>
  <Accordion title="¿Qué roles incluye Consuelo por defecto?">
    Consuelo incluye los roles **Admin** y **Member** por defecto. Puedes crear roles personalizados adicionales según las necesidades de tu equipo (p. ej., Representante de ventas, Gerente, Usuario de solo lectura).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué permisos de acción están disponibles?">
    ...
    * **Send Email**: Capacidad para enviar correos desde Consuelo
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué es el aprovisionamiento Just-in-Time (JIT)?">
    Con el aprovisionamiento JIT, las cuentas de usuario se crean automáticamente en Consuelo cuando alguien inicia sesión mediante SSO por primera vez. Se les asigna automáticamente el rol predeterminado.
  </Accordion>
