---
title: Generar una cotización o una factura desde Consuelo
...
* [Generar un PDF desde Consuelo](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — adjuntar los PDF generados a los registros
