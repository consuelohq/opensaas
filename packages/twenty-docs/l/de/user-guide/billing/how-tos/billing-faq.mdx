...
<AccordionGroup>
  <Accordion title="Kann ich Consuelo kostenlos beim Selbsthosting nutzen?">
    Ja, Sie können Consuelo kostenlos beim Selbsthosting nutzen. Sie erhalten Zugang zu allem, was im (Cloud-)Pro-Tarif enthalten ist, außer dem Support unseres Kernteams. Support ist über unsere Discord-Community zugänglich.
  ...
  <Accordion title="Bieten Sie kostenlose Plätze für Nur-Ansicht-Benutzer an?">
    Wir bieten keine kostenlosen Plätze an. Die Preisgestaltung erfolgt pro Benutzer, und jeder Benutzer benötigt eine Lizenz, um auf Consuelo zuzugreifen.
  </Accordion>
