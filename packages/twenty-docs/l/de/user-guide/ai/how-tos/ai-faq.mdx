---
title: KI-FAQ
description: Häufig gestellte Fragen zu KI-Funktionen in Consuelo.
---
...
<AccordionGroup>
  ...
  <Accordion title="Kann ich meine eigenen KI-Modelle verwenden?">
    Zunächst wird Consuelo integrierte KI-Modelle verwenden. Unterstützung für benutzerdefinierte oder externe KI-Modelle kann in zukünftigen Versionen basierend auf Nutzerfeedback hinzugefügt werden.
  </Accordion>
</AccordionGroup>
