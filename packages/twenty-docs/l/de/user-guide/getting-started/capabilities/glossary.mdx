---
title: Glossar
description: Machen Sie sich mit grundlegenden Begriffen vertraut, die in Consuelo verwendet werden.
---

## API

API (Application Programming Interface) ermöglicht es Ihnen, Consuelo mit anderen Softwaresystemen zu verbinden und benutzerdefinierte Integrationen zu erstellen.
...
Opportunities in Consuelo CRM sind potenzielle Deals oder Verkäufe mit Accounts oder Kontakten.
...
Tasks in Consuelo CRM sind zugewiesene Aktivitäten in Bezug auf Kontakte, Accounts oder Opportunities.
...
Webhooks sind automatisierte Nachrichten, die von Consuelo an andere Anwendungen gesendet werden, wenn bestimmte Ereignisse eintreten, und ermöglichen die Synchronisierung von Daten in Echtzeit.
...
Ein `Arbeitsbereich` repräsentiert typischerweise ein Unternehmen, das Consuelo verwendet. Er enthält alle Datensätze und Daten, die Sie und Ihre Teammitglieder zu Consuelo hinzufügen.
