...
Webhooks übermitteln Daten in Echtzeit an Ihre Systeme, wenn Ereignisse in Consuelo auftreten — kein Polling erforderlich. Verwenden Sie sie, um externe Systeme synchron zu halten, Automatisierungen auszulösen oder Benachrichtigungen zu senden.
...
Consuelo sendet Webhooks für diese Ereignistypen:
...
Consuelo signiert jede Webhook-Anfrage zu Sicherheitszwecken. Validieren Sie die Signaturen, um sicherzustellen, dass die Anfragen authentisch sind.
...
| **Workflow-Webhook-Trigger** | IN       | Daten aus externen Systemen in Consuelo empfangen                                  |
