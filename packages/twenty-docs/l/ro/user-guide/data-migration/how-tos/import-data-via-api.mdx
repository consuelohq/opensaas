...
description: Când și cum să utilizați API-urile Consuelo pentru importuri de date la scară mare.
---

## Prezentare generală

Consuelo oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Consuelo impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Consuelo acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Consuelo (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Consuelo
