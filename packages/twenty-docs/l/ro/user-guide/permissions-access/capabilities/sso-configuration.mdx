...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Consuelo folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Consuelo
...
* Eliminați-i din spațiul de lucru Consuelo
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Consuelo (dacă este disponibilă)
* **Proces de offboarding**: Includeți Consuelo în fluxul dvs. de deprovisionare
