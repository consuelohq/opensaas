...
<AccordionGroup>
  <Accordion title="Ce roluri sunt incluse implicit în Consuelo?">
    Consuelo include în mod implicit rolurile **Admin** și **Member**. Puteți crea roluri personalizate suplimentare în funcție de nevoile echipei dvs. (de exemplu, Reprezentant de vânzări, Manager, Utilizator doar pentru citire).
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Ce permisiuni pentru acțiuni sunt disponibile?">
    ...
    * **Send Email**: Posibilitatea de a trimite e-mailuri din Consuelo
...
<AccordionGroup>
  ...
  <Accordion title="Ce este provisionarea Just-in-Time (JIT)?">
    Cu provisionarea JIT, conturile de utilizator sunt create automat în Consuelo atunci când cineva se autentifică prin SSO pentru prima dată. Li se atribuie automat rolul implicit.
  </Accordion>
