---
title: Genera un preventivo o una fattura da Consuelo
...
* [Generare un PDF da Consuelo](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — allegare i PDF generati ai record
