...
Consuelo include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare Consuelo attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

Consuelo offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. Consuelo offre già:
