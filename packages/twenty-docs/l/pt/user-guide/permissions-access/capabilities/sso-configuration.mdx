...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no Consuelo usando o provedor de identidade da sua organização. Isso oferece:
...
O Consuelo oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do Consuelo
...
* **ID da Entidade**: Fornecido pelo Consuelo
* **URL ACS**: A URL de retorno para autenticação
* **Certificado**: Para comunicação segura

#### 4. Insira os detalhes do provedor no Consuelo
...
* Remova-os do workspace do Consuelo
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do Consuelo (se disponível)
* **Processo de desligamento**: Inclua o Consuelo no seu fluxo de trabalho de desprovisionamento
