---
title: Widgets
description: Explore os tipos de widget e as opções de visualização no Consuelo.
---
...
O Consuelo oferece vários tipos de widget para visualizar seus dados de CRM.
