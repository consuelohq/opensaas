...
description: Siga um guia passo a passo sobre como se registrar na Consuelo, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Consuelo](https://app.twenty.com).
