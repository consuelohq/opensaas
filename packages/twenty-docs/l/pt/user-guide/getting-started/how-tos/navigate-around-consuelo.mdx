...
O menu de comandos oferece **acesso rápido a ações** no Consuelo. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Consuelo dá suporte a exclusões lógicas e permanentes)
