...
A redação nativa de e-mails dentro do Consuelo está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/twentyhq/twenty/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
