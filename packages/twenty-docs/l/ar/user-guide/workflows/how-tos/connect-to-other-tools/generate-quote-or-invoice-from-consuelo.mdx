---
title: إنشاء عرض سعر أو فاتورة من Consuelo
...
* [Generate a PDF from Consuelo](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — attach generated PDFs to records
