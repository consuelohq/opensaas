...
description: قم بنشر Consuelo وإدارته على البنية التحتية الخاصة بك.
---

<Frame>
  <img src="/images/user-guide/what-is-consuelo/20.png" alt="الذكاء الاصطناعي" />
</Frame>

## نظرة عامة

يمكن استضافة Consuelo ذاتيًا على البنية التحتية الخاصة بك، مما يمنحك تحكمًا كاملاً في بياناتك وعمليات النشر.
