---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci Consuelo.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení Consuelo s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v Consuelo CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v Consuelo CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z Consuelo na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající Consuelo. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do Consuelo přidáte.
...
Členové pracovního prostoru jsou uživatelé Consuelo z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
