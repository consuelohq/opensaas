...
Consuelo obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit Consuelo podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

Consuelo nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. Consuelo již poskytuje:
