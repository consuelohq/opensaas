...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak Consuelo'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
Consuelo, SSO'yu şu sağlayıcılarla destekler:
...
* Consuelo çalışma alanına yönetici erişimi
...
* Consuelo çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını Consuelo rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza Consuelo'yi dahil edin
