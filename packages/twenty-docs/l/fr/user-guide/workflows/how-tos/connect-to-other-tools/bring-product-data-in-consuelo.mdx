---
title: Importer les données de produits dans Consuelo
...
Utilisez ce modèle pour garder Consuelo synchronisé avec les données produits de votre entrepôt de données (par ex. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record** : Créer ou mettre à jour dans Consuelo
