---
title: Générer un devis ou une facture depuis Consuelo
...
* [Générer un PDF à partir de Consuelo](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — joindre les PDF générés aux enregistrements
