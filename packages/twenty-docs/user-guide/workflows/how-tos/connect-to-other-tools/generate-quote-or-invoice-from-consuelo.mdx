---
title: Generate a Quote or Invoice from Consuelo
...
- [Generate a PDF from Consuelo](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-consuelo) — attach generated PDFs to records
