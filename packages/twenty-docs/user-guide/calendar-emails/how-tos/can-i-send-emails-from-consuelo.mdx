---
title: Can I Send Emails from Consuelo?
description: Information about sending emails directly from Consuelo.
---

## Current Status

Consuelo's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from Consuelo's interface.
...
While you can't send emails manually from Consuelo, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect Consuelo to a dedicated email marketing tool.
...
Native email composition from within Consuelo is on our roadmap. Join our [GitHub discussions](https://github.com/twentyhq/twenty/discussions) to share your use case and help prioritize this feature.
