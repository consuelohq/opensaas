...
description: Control which emails are imported into Consuelo.
---

## Overview

By default, Consuelo syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
