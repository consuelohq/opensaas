...
After uploading your file and mapping fields, Consuelo validates your data **before** importing. This allows you to catch and fix errors without affecting your existing data.

## How It Works

1. **Upload** your CSV file
2. **Map** your columns to Consuelo fields
...
### Duplicate Values
**Cause**: A unique field (email, domain) already exists in Consuelo or appears twice in your file.
