...
description: Step-by-step guide to migrate your Consuelo self-hosted instance to Consuelo Cloud.
---

## Overview

This guide walks you through migrating your data from a Consuelo self-hosted instance to Consuelo Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.consuelohq.com](https://app.consuelohq.com) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@consuelohq.com](mailto:contact@consuelohq.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
