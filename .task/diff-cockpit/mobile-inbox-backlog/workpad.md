...
- changed files: `.task/diff-cockpit/mobile-inbox-backlog/current.json`, `.task/diff-cockpit/mobile-inbox-backlog/session.json`, `.task/diff-cockpit/mobile-inbox-backlog/workpad.md`, `.task/tasks/diff-cockpit/mobile-inbox-backlog.json`, `packages/diff-cockpit/src/index.ts`, `packages/diff-cockpit/tests/diff-cockpit.test.ts`
- matched rules: none
