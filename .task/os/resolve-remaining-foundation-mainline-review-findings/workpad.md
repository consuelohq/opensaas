...
- Runtime/lifecycle: typed install health reconciliation, bounded MCP stdio, nonretryable local-agent 4xx handling, malformed SSE isolation, heartbeat normalization, and preserved error causes.
- Ingress/install: equal-port Caddy loop rejection, allowlisted Caddy environment, required Portless precedence, and corrected non-TTY test coverage.
- Managed nodes: deterministic repeat apply, expiring enrollment, authenticated workspace authority, foreground enrollment, verified Caddy installation, durable Caddy service activation, and scoped onboarding ownership.
- Control plane/routing: durable host-index deletion, failed-grant persistence before cleanup, rejection of untrusted pre-auth workspace identity, and sanitized edge-router error reporting.
- Tests/docs: finish-line regression suite, corrected lifecycle/installer contract fixtures, and managed-node operator documentation.
...
- Enrollment/heartbeat: assert grant expiry is honored, resolved status dependencies receive failures, capabilities deduplicate after trim, and non-Error causes remain attached.
...
- changed files: `.task/os/resolve-remaining-foundation-mainline-review-findings/current.json`, `.task/os/resolve-remaining-foundation-mainline-review-findings/session.json`, `.task/os/resolve-remaining-foundation-mainline-review-findings/verify.json`, `.task/os/resolve-remaining-foundation-mainline-review-findings/workpad.md`, `.task/tasks/os/resolve-remaining-foundation-mainline-review-findings.json`, `packages/os/SCRIPTS.md`, `packages/os/cloudflare/os-device-authority/src/routes/device.ts`, `packages/os/cloudflare/os-device-authority/src/services/grants.ts`, `packages/os/cloudflare/os-device-authority/src/stores.ts`, `packages/os/cloudflare/workspace-edge/src/index.ts`, `packages/os/scripts/bootstrap.sh`, `packages/os/scripts/install-tty.test.ts`, `packages/os/scripts/lib/gcloud-managed-cloud-node.ts`, `packages/os/scripts/lib/lifecycle/engine.ts`, `packages/os/scripts/lib/lifecycle/errors.ts`, `packages/os/scripts/lib/local-agent-mcp-bridge.ts`, `packages/os/scripts/lib/managed-cloud-node-enrollment.ts`, `packages/os/scripts/lib/managed-cloud-node.ts`, `packages/os/scripts/lib/security-gateway.ts`, `packages/os/scripts/lib/workspace-cloudflare-edge-router.ts`, `packages/os/scripts/lib/workspace-node-heartbeat-client.ts`, `packages/os/scripts/mcp-stdio.ts`, `packages/os/scripts/start-caddy-daemon.sh`, `packages/os/scripts/workspace-node-heartbeat.ts`, `packages/os/tests/cloudflare-edge-router.test.ts`, `packages/os/tests/daemon-bun-path.test.ts`, `packages/os/tests/foundation-finish-line-regressions.test.ts`, `packages/os/tests/gcloud-managed-cloud-node-instance.test.ts`, `packages/os/tests/install-workspace-bootstrap-contract.test.ts`, `packages/os/tests/managed-cloud-node-enrollment.test.ts`, `packages/os/tests/managed-cloud-node-instance-contract.test.ts`, `packages/os/tests/managed-cloud-review-regressions.test.ts`, `packages/os/tests/native-lifecycle-operation.test.ts`, `packages/os/tests/oauth-device-page-contract.test.ts`, `packages/os/tests/os-device-authority-worker.test.ts`, `packages/os/tests/platform-managed-cloud-node-instance.test.ts`, `packages/os/tests/workspace-node-registry-routing.test.ts`
